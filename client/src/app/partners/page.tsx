...
export const metadata: Metadata = {
  ...
  description: 'Partner with CACBLAZE to reach millions of engaged users. Explore our partnership programs.',
};
...
export default function PartnersPage() {
  ...
  const programs = [
    { 
      ...
      description: 'Expand your audience by distributing your high-quality articles, videos, and courses to our global community of learners. Benefit from our SEO authority and recommendation engine.', 
      icon: 'DocumentDuplicateIcon',
      benefits: ['Global Reach', 'Brand Authority', 'Traffic Backlinks']
    },
    { 
      title: 'Affiliate Program', 
      description: 'Monetize your traffic by recommending our premium courses and tools. We offer competitive commission rates, real-time tracking, and dedicated support to help you succeed.', 
      icon: 'CurrencyDollarIcon',
      benefits: ['High Commission', '30-Day Cookie', 'Marketing Assets']
    },
    { 
      title: 'Advertising', 
      description: 'Reach our high-intent audience of professionals and students with native advertising solutions. Place your brand in a context where users are actively seeking knowledge.', 
      icon: 'MegaphoneIcon',
  ...
  const testimonials = [
    { 
      quote: "Partnering with CACBLAZE has doubled our course enrollments in just six months. The audience is highly engaged and eager to learn.", 
      author: "TechSkills Academy", 
      role: "Education Partner" 
    },
    { 
      quote: "The affiliate program is transparent and profitable. It's rare to find a platform that values its partners this much.", 
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto border-t border-teal-800 pt-12">
              {stats.map((stat, idx) => (
                <div key={idx}>
                  ...
                  <div className="text-teal-200 text-sm font-medium uppercase tracking-wide">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Choose the partnership model that fits your business goals. We provide the tools and support you need to succeed.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 mb-24">
              {programs.map((program) => (
                <div key={program.title} className="p-8 rounded-2xl bg-white border border-gray-200 hover:border-teal-500 hover:shadow-xl transition-all group flex flex-col h-full">
               ...
               <div className="relative z-10">
                 ...
                 <div className="grid md:grid-cols-2 gap-8">
                   {testimonials.map((t, idx) => (
                     <div key={idx} className="bg-teal-800/50 p-8 rounded-2xl border border-teal-700 backdrop-blur-sm">
            ...
            <div className="bg-gray-50 rounded-3xl p-12 text-center border border-gray-100">
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-xl mx-auto">
                Fill out our partnership inquiry form and a member of our business development team will get back to you within 24 hours.
              </p>
              <a href="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-teal-600 text-white font-bold rounded-full hover:bg-teal-700 transition-colors">
