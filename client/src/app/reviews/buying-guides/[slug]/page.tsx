        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 text-center">
            ...
            <div className="flex items-center justify-center gap-6 pb-4">
              ...
              <div className="text-left">
                <div className="text-xs text-gray-500 uppercase tracking-widest font-bold">Last Updated</div>
            ...
            <div className="lg:col-span-8">
              ...
              <div className="space-y-16">
                ...
                {guide.recommendations.map((rec, index) => (
                  <div key={index} className="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-500">
                    <div className="grid md:grid-cols-2">
                      <div className="relative aspect-[4/3] md:aspect-auto">
                        <AppImage src={rec.image} alt={rec.productName} fill className="object-cover" />
                      ...
                      <div className="p-8 lg:p-10">
                        ...
                        <div className="text-indigo-600 font-extrabold text-xl mb-6">{rec.priceRange}</div>
                        ...
                        >
                          View Full Review <Icon name="ArrowRightIcon" className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
                        </Link>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-24">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  {guide.buyingTips.map((tip, index) => (
                    <div key={index} className="bg-indigo-50 p-8 rounded-3xl border border-indigo-100">
              ...
              <div className="sticky top-24 space-y-8">
                ...
                <div className="bg-indigo-600 rounded-3xl p-8 text-white shadow-2xl overflow-hidden relative">
                  ...
                  <p className="text-indigo-100 mb-8 relative">
                    Tech prices in Nigeria change daily. Subscribe to get our weekly price watch and deal alerts.
                  </p>
                  <input 
                    type="email" 
                ...
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {['Laptops', 'Smartphones', 'Gadgets', 'Accessories'].map((cat) => (
                      <button key={cat} className="flex items-center justify-between w-full p-4 rounded-2xl hover:bg-gray-50 transition-colors group">
                        <span className="font-semibold text-gray-700 group-hover:text-indigo-600">{cat} Guides</span>
                        <Icon name="ChevronRightIcon" className="h-5 w-5 text-gray-400 group-hover:text-indigo-600" />
                      </button>
                    ))}
                  </div>
                </div>
