...
export const metadata: Metadata = {
  ...
  description: 'Honest reviews of the best ISPs in Nigeria. From Fiber-to-the-Home (FTTH) like ipNX and MTN to Satellite internet like Starlink.',
  keywords: 'best isp nigeria, starlink nigeria review, ipnx fiber review, mtn fiber, airtel 5g router review'
};
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Reliable internet is the backbone of the digital age. We test and review Nigeria's leading ISPs to help you stay connected without the frustration.
            </p>
          </div>
              ...
              >
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
                    <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">{review.specs.basePrice}</span>
