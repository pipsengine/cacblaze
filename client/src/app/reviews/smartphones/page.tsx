  ...
  const smartphones = [
    {
      ...
      description:
        'The titanium powerhouse that rules the Nigerian market with its resale value and video capabilities.',
      image:
        'https://images.unsplash.com/photo-1695048133142-1a20484d2569?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80',
    ...
    },
    {
      ...
      description:
        'Tecno brings foldable technology to a more accessible price point without compromising too much.',
      image:
        'https://images.unsplash.com/photo-1596558450268-9c27524ba856?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1592434134753-a70baf7979d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80',
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Whether you have ₦150k or ₦2M, we've tested the best phones for the Nigerian market.
                We look at battery life (crucial for NEPA issues), camera quality, and resale value.
              </p>
            </div>
          </div>
        </section>
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            <div className="flex items-start text-sm">
                              <Icon
                                name="PlusCircleIcon"
                                className="h-4 w-4 text-indigo-600 mr-2 mt-0.5 flex-shrink-0"
                              />
