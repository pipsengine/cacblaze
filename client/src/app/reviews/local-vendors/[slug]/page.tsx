...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/reviews/local-vendors/${review.slug}` },
  };
}
...
export default async function LocalVendorReviewPage({ params }: PageProps) {
  ...
  const jsonLd = [{ ...reviewLd, url: `${origin}/reviews/local-vendors/${review.slug}` }];
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              {review.specs.deliveryAvailable ? 'Available' : 'In-store Only'}
                            </div>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              {review.specs.paymentMethods.join(', ')}
                            </div>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
