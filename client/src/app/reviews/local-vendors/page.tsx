...
export const metadata: Metadata = {
  ...
  description: 'Honest reviews of the best local vendors in Nigeria. From electronics stores like Slot and Pointek to supermarkets like Hubmart and H-Medix.',
  keywords: 'slot systems review, hubmart stores lagos, pointek online, local vendors nigeria, best electronics stores lagos'
};
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              We review Nigeria's top retail outlets and local vendors to help you find the most reliable places for electronics, groceries, health, and lifestyle needs.
            </p>
          </div>
