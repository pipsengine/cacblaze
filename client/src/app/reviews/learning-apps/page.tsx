        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl leading-relaxed">
              Unlock your potential with our expert reviews of the world's best education platforms.
              From coding and languages to K-12 and university degrees.
            </p>
          </div>
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {review.subjects.slice(0, 3).map((subject, idx) => (
                      <span
                        key={idx}
                        className="bg-gray-100 text-gray-600 text-[10px] px-2 py-1 rounded font-bold uppercase"
                      >
                        {subject}
                      </span>
                    ))}
