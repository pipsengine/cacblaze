...
import { cafeReviews } from '@/data/cafes';
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${review.name} Review: Best Coffee in ${review.location} - CACBLAZE`,
    description: `Read our comprehensive review of ${review.name} in ${review.location}. Covering specialty coffee, WiFi quality, pricing, and atmosphere for Nigerian coffee lovers.`,
  };
}

export default async function CafeReviewPage({ params }: PageProps) {
  const { slug } = await params;
  const review = cafeReviews[slug];
  ...
  const breadcrumbItems = [
    ...
    { name: review.name, href: `/reviews/cafes/${review.slug}` }
  ];
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5">
                <div className="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden sticky top-24">
                  ...
                  <div className="p-8">
                    <div className="mb-6">
                      <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-4">Cafe Information</h4>
