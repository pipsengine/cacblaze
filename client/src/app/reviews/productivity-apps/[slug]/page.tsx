                ...
                <div className="md:col-span-1">
                  <div className="sticky top-24 space-y-6">
                    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs font-bold text-gray-900 text-right">{review.specs.pricingModel}</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-gray-500 font-bold uppercase tracking-widest">Offline Mode</span>
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-gray-500 font-bold uppercase tracking-widest">Cloud Sync</span>
                          <span className={`text-xs font-bold ${review.specs.cloudSync ? 'text-emerald-600' : 'text-rose-500'}`}>
                            {review.specs.cloudSync ? 'Yes' : 'No'}
                          </span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-gray-500 font-bold uppercase tracking-widest">Collaboration</span>
                          <span className={`text-xs font-bold ${review.specs.collaboration ? 'text-emerald-600' : 'text-rose-500'}`}>
                      ...
                      <div className="mt-8 pt-6 border-t border-gray-50">
                        <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-4">Core Capabilities</h4>
                    ...
                    <button className="w-full bg-gray-900 text-white py-4 rounded-2xl font-bold text-sm hover:bg-gray-800 transition-colors flex items-center justify-center gap-2">
                      Visit Official Website <Icon name="ArrowTopRightOnSquareIcon" className="h-4 w-4" />
                    </button>
                  </div>
                </div>
              </div>
