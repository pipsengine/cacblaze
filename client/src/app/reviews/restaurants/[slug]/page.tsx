...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${review.name} Review: Best Dining in ${review.location} - CACBLAZE`,
    description: `Read our comprehensive review of ${review.name} in ${review.location}. Covering ${review.cuisine} cuisine, pricing, and essential features for Nigerian diners.`,
  };
}

export default async function RestaurantReviewPage({ params }: PageProps) {
  const { slug } = await params;
  const review = restaurants[slug];
  ...
  const breadcrumbItems = [
    ...
    { name: 'Restaurants', href: '/reviews/restaurants' },
    { name: review.name, href: `/reviews/restaurants/${review.slug}` }
  ];
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5">
                <div className="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden sticky top-24">
                  ...
                  <div className="p-8">
                    <div className="mb-6">
                      <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-4">Restaurant Info</h4>
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">{review.specs.openingHours}</div>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <div className="text-sm font-bold text-gray-900">Price Level</div>
                            <div className="text-sm text-gray-600 font-medium">{review.priceLevel}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-4">Features</h4>
