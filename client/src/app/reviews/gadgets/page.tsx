...
export const metadata: Metadata = {
  ...
  description: 'From gaming consoles to drones and satellite internet, we review the most exciting tech gadgets landing in Nigeria. Find out if they are worth your money.',
  keywords: 'ps5 pro price nigeria, starlink review nigeria, dji mini 4 pro price, tech gadgets nigeria, best drones for creators'
};
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Exploring the frontiers of technology in Nigeria. We test drones, consoles, and smart home gear to see how they perform in local conditions.
            </p>
          </div>
