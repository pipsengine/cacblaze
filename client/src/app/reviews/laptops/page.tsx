        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              We test the latest laptops for performance, battery life, and value in the Nigerian
              context. Whether you're a student, creator, or professional, we've got you covered.
            </p>
          </div>
