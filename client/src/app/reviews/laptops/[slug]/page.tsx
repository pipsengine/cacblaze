...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const review = laptopReviews[slug];
  ...
  return {
    ...
    description: `${review.tagline}. Read our comprehensive review of the ${review.name} covering performance, battery, and display quality for Nigerian users.`,
    alternates: { canonical: `/reviews/laptops/${review.slug}` },
  };
}

export default async function LaptopReviewPage({ params }: PageProps) {
  const { slug } = await params;
  const review = laptopReviews[slug];
  ...
  const jsonLd = [{ ...reviewLd, url: `${origin}/reviews/laptops/${review.slug}` }];

  const breadcrumbItems = [
    { name: 'Home', href: '/homepage' },
    { name: 'Reviews', href: '/reviews' },
    { name: 'Laptops', href: '/reviews/laptops' },
    { name: review.name, href: `/reviews/laptops/${review.slug}` },
  ];
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5 relative">
                <div className="aspect-[4/3] relative rounded-2xl overflow-hidden shadow-lg border border-gray-200">
                  <AppImage
            ...
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
                {review.gallery.map((img, idx) => (
                  <div
                    key={idx}
                    className="aspect-video relative rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow"
                  >
                    <AppImage
                      src={img}
            ...
            <div className="lg:col-span-4">
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                  ...
                  <Icon name="CpuChipIcon" className="h-5 w-5 text-gray-400" />
                </div>
