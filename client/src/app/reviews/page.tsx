...
const reviewsCategories = [
  ...
  },
  {
    ...
    title: 'Software & Apps',
    items: [
      { id: 'rev_saas', label: 'SaaS', href: '/reviews/saas', icon: 'CloudIcon', description: 'Enterprise software and cloud-based solutions.' },
      { id: 'rev_digital_platforms', label: 'Digital Platforms', href: '/reviews/digital-platforms', icon: 'GlobeAltIcon', description: 'E-commerce, social media, and payment giants.' },
      ...
      { id: 'rev_course_platforms', label: 'Course Platforms', href: '/reviews/course-platforms', icon: 'AcademicCapIcon', description: 'Best online education and skill platforms.' },
  ...
  },
  {
    ...
    items: [
      { id: 'rev_subscriptions', label: 'Subscriptions', href: '/reviews/subscriptions', icon: 'CreditCardIcon', description: 'Analysis of digital memberships and recurring services.' },
      { id: 'rev_online_services', label: 'Online Services', href: '/reviews/online-services', icon: 'GlobeAltIcon', description: 'Comprehensive reviews of global digital services.' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'rev_tech_books', label: 'Tech Books', href: '/reviews/tech-books', icon: 'CommandLineIcon', description: 'Programming, architecture, and engineering manuals.' },
