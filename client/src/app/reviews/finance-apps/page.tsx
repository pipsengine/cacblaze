...
export const metadata: Metadata = {
  ...
  description:
    'Expert reviews of the best finance apps in Nigeria. From digital banks like Kuda to savings apps like PiggyVest and Cowrywise.',
  keywords:
    'best finance apps nigeria, kuda bank review, piggyvest review, cowrywise review, opay review, moniepoint review',
};
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl leading-relaxed">
              We've tested and reviewed the top fintech applications in Nigeria to help you manage
              your money, save better, and invest smarter in 2026.
            </p>
          </div>
