                    ...
                    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span
                            className={`text-xs font-bold ${review.specs.savingsOptions ? 'text-emerald-600' : 'text-rose-500'}`}
                          >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span
                            className={`text-xs font-bold ${review.specs.investmentOptions ? 'text-emerald-600' : 'text-rose-500'}`}
                          >
