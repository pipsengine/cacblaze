...
export const metadata: Metadata = {
  ...
  description:
    'Expert reviews of the best business tools, from communication platforms like Slack to CRMs like Salesforce and accounting software like QuickBooks.',
  keywords:
    'best business tools, crm reviews, slack review, zoom review, salesforce review, quickbooks review, asana review, shopify review',
};
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl leading-relaxed">
              Scale your business with the right software. From team collaboration and video
              conferencing to complex CRMs and e-commerce platforms.
            </p>
          </div>
