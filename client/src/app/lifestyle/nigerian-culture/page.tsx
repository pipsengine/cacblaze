...
export const metadata: Metadata = {
  ...
  description: 'Explore Nigerian culture through recipes, festivals, traditions, and inspiring success stories from Nigerian entrepreneurs and professionals.',
  keywords: 'Nigerian culture, Nigerian recipes, Nigerian festivals, Nigerian success stories, Nigerian traditions'
};
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-secondary mb-8 leading-relaxed">
                Celebrate Nigerian heritage through food, festivals, traditions, and inspiring success stories.
              </p>
            </div>
          </div>
        </section>
                  ...
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-6 right-6">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="text-white/90 text-sm font-semibold">{category.count}</span>
                      </div>
        ...
        <section className="py-16 bg-gradient-to-br from-muted/30 to-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link href="/nigerian-culture/recipes" className="text-primary font-medium hover:text-primary/80 transition-colors">
                View All →
              </Link>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link href="/nigerian-culture/festivals" className="text-primary font-medium hover:text-primary/80 transition-colors">
                View Calendar →
              </Link>
            </div>
        ...
        <section className="py-16 bg-gradient-to-br from-primary/5 to-accent/5">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link href="/nigerian-culture/success-stories" className="text-primary font-medium hover:text-primary/80 transition-colors">
                Read More →
              </Link>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
