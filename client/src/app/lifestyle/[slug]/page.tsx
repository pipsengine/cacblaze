        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              detail: 'Pick 3–5 drills and log frequency. Small streaks compound quickly.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              detail: 'Short check‑ins prevent isolation. Ask for perspective and practical ideas.',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              detail: 'Community increases adherence. Pick low‑pressure groups you enjoy.',
            },
            {
              text: 'Set boundaries and protect energy when demands become excessive.',
              detail: 'Use clear, kind “no’s.” Boundaries create space for health and priorities.',
            },
            {
              text: 'Share goals weekly within a small accountability circle for support.',
              detail: 'Short updates keep momentum and invite encouragement when motivation dips.',
            },
            {
              text: 'Plan light social activities outdoors for combined mood and health benefits.',
              detail: 'Walks, park meetups, and markets add sunlight and movement to social time.',
            },
            {
              text: 'Practice kind speech and empathy to strengthen relationships rapidly.',
              detail: 'Assume good intent; listen actively. Relationships are a core health lever.',
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              detail: 'Tiny starts lower resistance. Expand duration after several easy wins.',
            },
            {
              text: 'Use visible trackers and celebrate small wins to reinforce identity.',
              detail: 'Paper calendars, app streaks, or habit bracelets make progress tangible.',
            },
            {
              text: 'Prefer repetition over intensity and avoid all or nothing patterns.',
              detail: 'Show up even when short on time. Identity builds through frequent reps.',
            },
            {
              text: 'Design environments that reduce friction and prompt intended actions.',
              detail: 'Lay out clothes, prep ingredients, and set reminders in the right place.',
            },
            {
          ...
          items: [
            {
              ...
              detail: 'Make good choices the default. Convenience beats willpower in busy weeks.',
            },
            {
            ...
            },
            {
              ...
              detail: 'Lighting guides your body clock. Match brightness to the time of day.',
            },
            {
              text: 'Create quiet corners for reading, reflection, and mindful breathing.',
              detail: 'A small chair and lamp can become your nightly wind‑down station.',
            },
            {
          ...
          items: [
            {
              ...
              detail: 'One page is enough. Track trends, not perfection. Adjust the basics first.',
            },
            {
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Prioritize 7–9 hours for most adults; teens may need more.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Get bright morning light for circadian alignment.',
              detail:
                'Seek outdoor light shortly after waking. Even 10–15 minutes improves alertness and synchronizes your internal clock.',
            },
            {
              text: 'Dim indoor lighting after sunset; prefer warm tones.',
              detail: 'Lower intensity and color temperature at night to signal winding down.',
            },
            {
              text: 'Limit blue‑heavy screens at night; use filters if needed.',
              detail:
                'If screens are unavoidable, enable night filters and reduce brightness significantly.',
            },
            {
              text: 'Expose eyes to natural light during the day when possible.',
              detail:
                'Regular daylight helps maintain healthy rhythms and supports mood and energy.',
            },
            {
              text: 'Keep bedroom dark with blackout curtains if sensitive.',
              detail: 'Block streetlights and early dawn light that can disrupt sleep continuity.',
            },
            {
              text: 'Use low night‑lights for safe navigation without bright exposure.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Limit caffeine after mid‑day to reduce sleep disruption.',
              detail:
                'Caffeine timing matters more than total dose. Shift intake earlier to protect sleep onset.',
            },
            {
              text: 'Avoid large late meals; prefer lighter dinners.',
              detail:
                'Digesting big meals raises temperature and can cause reflux. Keep evening meals simple and moderate.',
            },
            {
              text: 'Balance evening snacks with protein/fiber to avoid sugar spikes.',
              detail:
                'Stable blood sugar reduces nighttime awakenings. Pair fruit or whole‑grain carbs with yogurt or nuts.',
            },
            {
              text: 'Hydrate earlier to reduce nocturnal awakenings.',
              detail: 'Front‑load fluids and taper toward evening to minimize bathroom trips.',
            },
            {
              text: 'Moderate alcohol; it fragments sleep even if it aids onset.',
              detail:
                'Alcohol shortens deep sleep and increases awakenings. Reduce or avoid near bedtime.',
            },
            {
              text: 'Observe personal triggers and adjust accordingly.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Keep bedroom dark, cool, and quiet.',
              detail:
                'Set a cool room temperature, block light sources, and minimize noise to support deeper sleep.',
            },
            {
              text: 'Declutter space to reduce visual stress.',
              detail: 'A tidy room lowers mental load and speeds the wind‑down process.',
            },
            {
              text: 'Use comfortable bedding and breathable fabrics.',
              detail:
                'Choose materials that regulate heat and moisture to prevent discomfort overnight.',
            },
            {
              text: 'Reserve bed for sleep and intimacy; avoid work in bed.',
              detail:
                'Keeping the bed for rest strengthens the mental association with sleep, easing onset.',
            },
            {
              text: 'Place clocks out of direct view to reduce time anxiety.',
              detail:
                'Clock‑watching increases stress. Turn displays away or use non‑glowing clocks.',
            },
            {
              text: 'Add calming cues (aroma, soft light) sparingly.',
              detail:
    ...
    hygiene: {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            {
              text: 'Choose gentle cleansers and moisturize after bathing.',
              detail:
                'Use lukewarm water; avoid harsh soaps. Apply moisturizer while skin is slightly damp to lock in hydration.',
            },
            {
              text: 'Protect skin from excessive sun; hydrate well.',
              detail:
                'Use broad‑spectrum protection and cover exposed areas. Drink water consistently throughout the day.',
            },
            {
              text: 'Keep hair care simple and consistent.',
              detail:
                'Match shampoo/conditioner to scalp and hair type. Avoid over‑washing that strips natural oils.',
            },
            {
              text: 'Manage common irritants.',
              detail:
                'Patch test new products and avoid fragrances if sensitive. Seek hypoallergenic options when needed.',
            },
            {
              text: 'Trim nails and clean regularly.',
              detail: 'Short, filed nails reduce dirt accumulation and the risk of scratches.',
            },
            {
              text: 'Mind shared tools and towels.',
              detail: 'Avoid sharing combs, razors, or towels to reduce microbial transfer.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            {
              text: 'Cook meats thoroughly; refrigerate leftovers quickly.',
              detail:
                'Use appropriate internal temperatures. Cool and store within two hours to prevent bacterial growth.',
            },
            {
              text: 'Wash produce and separate raw/cooked items.',
              detail:
                'Rinse fruit and vegetables; use separate cutting boards for raw meat and ready‑to‑eat foods.',
            },
            {
              text: 'Follow safe reheating practices.',
              detail:
                'Reheat to steaming hot throughout; avoid repeated reheats that increase risk.',
            },
            {
              text: 'Label and date stored foods.',
              detail: 'Track storage times and discard items beyond safe windows.',
            },
            {
              text: 'Keep cold chain during transport.',
              detail: 'Use coolers or insulated bags for perishable groceries in hot weather.',
            },
            {
              text: 'Sanitize prep areas after cooking.',
              detail: 'Clean counters and tools promptly, especially after handling raw meat.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Use tissues or elbows for coughs/sneezes.',
              detail:
                'Cover properly to reduce droplet spread. Dispose of tissues and clean hands afterward.',
            },
            {
              text: 'Maintain respectful distance in crowded areas.',
              detail: 'Reduce close contact when possible, especially during illness seasons.',
            },
            {
              text: 'Wash hands after public transport.',
              detail: 'Clean hands after buses, trains, ride‑shares, and before eating.',
            },
            {
              text: 'Avoid touching shared surfaces unnecessarily.',
              detail: 'Use knuckles or elbows for buttons and handles when practical.',
            },
            {
              text: 'Carry a small hygiene kit.',
              detail:
                'Include sanitizer, tissues, and a spare mask if needed for specific environments.',
            },
            {
              text: 'Respect local health advisories.',
              detail: 'Follow posted guidelines for clinics, schools, and event venues.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Follow recommended vaccinations and screenings.',
              detail:
                'Check age‑ and risk‑appropriate schedules; maintain a simple record of completed items.',
            },
            {
              text: 'Know allergy triggers and carry required meds.',
              detail:
                'Keep antihistamines or prescribed devices accessible and communicate needs to close contacts.',
            },
            {
              text: 'Use reputable sources for guidance.',
              detail:
                'Prefer licensed professionals and evidence‑based references over unverified claims.',
            },
            {
              text: 'Schedule routine checkups.',
              detail: 'Plan annual or biannual visits for general health maintenance.',
            },
            {
              text: 'Maintain basic first‑aid supplies.',
              detail:
                'Stock bandages, antiseptics, and pain relievers; review expiry dates periodically.',
            },
            {
              text: 'Prepare an emergency contacts list.',
              detail: 'Keep phone numbers for clinics, hotlines, and nearby trusted helpers.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Separate heavily soiled items and wash properly.',
              detail:
                'Use appropriate temperature settings and pre‑treat stains for effective cleaning.',
            },
            {
              text: 'Dry fully to prevent damp odors.',
              detail: 'Ensure complete drying before folding or storing to reduce mildew risk.',
            },
            {
              text: 'Clean machines periodically.',
              detail: 'Run maintenance cycles, wipe seals, and clear filters to prevent buildup.',
            },
            {
              text: 'Use correct detergent amounts.',
              detail:
                'Follow manufacturer guidelines; excess soap can leave residue and irritate skin.',
            },
            {
              text: 'Air out hampers.',
              detail:
                'Prevent moisture accumulation by keeping laundry baskets dry and ventilated.',
            },
            {
              text: 'Store clean clothes properly.',
              detail: 'Fold or hang promptly to avoid wrinkles and dust accumulation.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Create weekly checklists for key tasks.',
              detail:
                'List surfaces, rooms, and laundering steps to maintain a predictable cadence.',
            },
            {
              text: 'Keep supplies accessible in each room.',
              detail:
                'Store small cleaning kits where needed to lower friction and prompt quick wipes.',
            },
            {
              text: 'Review and adjust routines seasonally.',
              detail: 'Adapt schedules and products to weather changes and household events.',
            },
            {
              text: 'Use brief daily resets.',
              detail: 'Five‑minute tidying bursts prevent buildup and make weekly tasks faster.',
            },
            {
              text: 'Share responsibilities clearly.',
              detail:
            ...
            },
            {
              ...
              detail: 'Reinforce the habit loop by acknowledging effort and improvements.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Define the 2‑minute version of any habit.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Log habits and review weekly.',
              detail:
                'A brief weekly review highlights patterns and obstacles, guiding small adjustments without overhauls.',
            },
            {
              text: 'Use simple rewards and celebrate tiny wins.',
              detail:
                'Immediate, modest rewards reinforce the loop; acknowledgment matters more than extravagance.',
            },
            {
              text: 'Share progress with a partner for accountability.',
              detail: 'Public or partner updates create gentle social pressure and encouragement.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            {
              text: 'Set realistic times that align with energy peaks.',
              detail: 'Schedule habits when energy is naturally higher to reduce willpower costs.',
            },
            {
              text: 'Plan “if‑then” contingencies for busy days.',
              detail: 'Define backups: If I miss morning, I will do a 5‑minute version at lunch.',
            },
            {
              text: 'Batch related habits in short stacks.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Adjust scope every few weeks based on results.',
              detail: 'Increase or decrease duration/complexity based on adherence, not ambition.',
            },
            {
              text: 'Replace failing cues or contexts.',
              detail:
                'If a trigger rarely works, test a different cue or location until reliability improves.',
            },
            {
              text: 'Keep friction low and rewards immediate.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Join groups or challenges to sustain motivation.',
              detail:
                'Community structures support persistence via encouragement and shared milestones.',
            },
            {
              text: 'Share goals and weekly summaries.',
              detail: 'Regular check‑ins create gentle accountability without pressure.',
            },
            {
              text: 'Avoid competitive comparisons; focus on your path.',
              detail: 'Comparison can demotivate; measure against your previous baseline.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Evolve habits as life changes.',
              detail:
                'Adjust routines to new schedules, responsibilities, or health contexts so they remain relevant.',
            },
            {
              text: 'Review monthly and retire outdated routines.',
              detail: 'Eliminate low‑value habits to reclaim time and attention for priorities.',
            },
            {
              text: 'Build backups for travel and disruptions.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Add one habit to a stable anchor.',
              detail:
                'Place the new behavior immediately after a reliable routine to inherit its stability.',
            },
            {
              text: 'Keep stacks short and specific.',
              detail: 'Limit to 2–3 linked actions to avoid complexity that breaks under stress.',
            },
            {
              text: 'Refine order by friction and flow.',
              detail: 'Arrange steps so each sets up the next with minimal movement or setup.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Pre‑commit materials and locations.',
              detail: 'Decide and prepare the where/what in advance so you can start instantly.',
            },
            {
              text: 'Automate triggers when possible.',
              detail:
                'Use device automations or calendar blocks to initiate cues without manual effort.',
            },
            {
              text: 'Eliminate decision points.',
              detail: 'Standardize routines so you do not choose among options during execution.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Use immediate, intrinsic rewards.',
              detail:
                'Choose satisfying endings (checklist tick, short reflection) to cement the loop.',
            },
            {
              text: 'Avoid large extrinsic rewards.',
              detail: 'Big rewards create dependency and can distort behavior when removed.',
            },
            {
              text: 'Celebrate process, not outcomes.',
              detail: 'Reinforce the act of showing up to stabilize identity and consistency.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Identify cue‑routine‑reward.',
              detail:
                'Map the loop to see where to intervene (swap routine, change reward, remove cue).',
            },
            {
              text: 'Increase friction strategically.',
              detail:
                'Make the undesired behavior harder (move app, hide snacks) to reduce impulse execution.',
            },
            {
              text: 'Replace with better alternatives.',
              detail: 'Define a positive substitute routine that satisfies the same need.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Reserve fixed windows for key habits.',
              detail: 'Protect time on your calendar to reduce conflict with other tasks.',
            },
            {
              text: 'Add buffers before/after blocks.',
              detail: 'Transitions prevent spillover and maintain the habit’s start on time.',
            },
            {
              text: 'Review blocks weekly.',
              detail: 'Adjust durations and placements based on adherence and energy.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Pick one habit that improves others.',
              detail:
                'Sleep, hydration, or planning can cascade benefits across multiple routines.',
            },
            {
              text: 'Prioritize foundational behaviors.',
              detail: 'Support habits that increase bandwidth and reduce stress for the rest.',
            },
            {
              text: 'Track cross‑effects explicitly.',
              detail: 'Note which habits improve mood or productivity to guide focus.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Define “rainy day” versions.',
              detail: 'When conditions fail, use a reduced action that preserves momentum.',
            },
            {
              text: 'Prepare travel and illness adaptations.',
              detail: 'Have safe, portable routines ready for disrupted contexts.',
            },
            {
              text: 'Use reset rituals after slips.',
              detail:
    ...
    'home-wellness': {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            {
              text: 'Create quiet corners or use noise control.',
              detail:
                'Use rugs, curtains, and soft materials to dampen sound; consider white noise for focus.',
            },
            {
              text: 'Schedule noisy tasks away from rest periods.',
              detail:
                'Batch vacuuming, laundry, or repairs when they won’t disrupt naps or focused work.',
            },
            {
              text: 'Use soft furnishings to dampen echo.',
              detail: 'Wall hangings and bookshelves break up reflections in open rooms.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Morning resets: air rooms, tidy surfaces.',
              detail:
                'Simple, repeatable steps set the tone for the day and prevent clutter buildup.',
            },
            {
              text: 'Evening wind‑down: low light and calm tasks.',
              detail: 'Reduce stimulation before sleep with gentle chores and quiet activities.',
            },
            {
              text: 'Weekly deep clean for hygiene and clarity.',
              detail: 'Plan a short, focused block to maintain sanitation and reduce stress.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            {
              text: 'Organize staples for quick healthy meals.',
              detail: 'Group ingredients by use; maintain an inventory to speed up meal prep.',
            },
            {
              text: 'Use batch cooking on weekends.',
              detail: 'Cook base components once; portion and freeze for fast, nutritious meals.',
            },
            {
              text: 'Rotate fridge items to reduce waste.',
              detail: 'Move older items forward and plan meals around what needs to be used first.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Check smoke alarms and first‑aid supplies.',
              detail: 'Test alarms monthly; keep basic supplies accessible and labeled.',
            },
            {
              text: 'Secure cables and reduce trip hazards.',
              detail: 'Route cords along walls; use cable clips and tidy mats to prevent falls.',
            },
            {
              text: 'Store chemicals safely and label clearly.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Keep personal touches that boost mood.',
              detail: 'Photos, art, or plants personalize spaces and support emotional well‑being.',
            },
            {
              text: 'Use calm colors and textures.',
              detail: 'Favor balanced palettes and soft materials to reduce visual noise.',
            },
            {
              text: 'Maintain a simple, tidy visual field.',
              detail: 'Clear surfaces and hidden storage improve focus and relaxation.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Share chores and routines within the household.',
              detail:
                'Assign responsibilities and keep a visible checklist for fairness and clarity.',
            },
            {
              text: 'Agree on quiet hours and boundaries.',
              detail: 'Set norms for noise, device use, and shared spaces to reduce conflict.',
            },
            {
              text: 'Post shared checklists in common areas.',
              detail: 'Centralized lists make routines visible and easier to follow.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Learn common changes per trimester.',
              detail:
                'Review typical physical and emotional changes to anticipate needs and prepare adjustments.',
            },
            {
              text: 'Track energy and symptoms weekly.',
              detail: 'Use a simple log to notice patterns and discuss them during visits.',
            },
            {
              text: 'Adjust routines based on stage.',
              detail:
                'Modify movement, sleep, and workload as comfort and medical guidance evolve.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Prioritize whole foods and hydration.',
              detail:
                'Emphasize fruits, vegetables, proteins, and steady fluids to support energy and development.',
            },
            {
              text: 'Follow professional supplement guidance.',
              detail:
                'Use recommended prenatal vitamins and specific supplements only under clinical advice.',
            },
            {
              text: 'Limit caffeine and ultra‑processed foods.',
              detail: 'Keep stimulants low and choose minimally processed options for stability.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Schedule regular checkups and tests.',
              detail:
                'Attend recommended appointments and screenings to monitor health and progress.',
            },
            {
              text: 'Record vitals and notes.',
              detail:
                'Keep a simple record of measurements, questions, and outcomes for continuity.',
            },
            {
              text: 'Prepare questions for visits.',
              detail:
                'List topics in advance (symptoms, plans, medications) to make sessions effective.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Know urgent symptoms that require care.',
              detail:
                'Understand red flags (severe pain, bleeding, concerning changes) and seek help promptly.',
            },
            {
              text: 'Maintain emergency contacts.',
              detail: 'Store key numbers visibly and on your phone for rapid access.',
            },
            {
              text: 'Avoid self‑medicating without guidance.',
              detail: 'Consult professionals before taking medications or remedies.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Use gentle walks and mobility.',
              detail: 'Favor low‑impact movement to support circulation and mood.',
            },
            {
              text: 'Avoid high‑risk exercises.',
              detail:
                'Skip activities with fall or impact risk; follow clinical advice for modifications.',
            },
            {
              text: 'Listen to fatigue signals.',
              detail: 'Adjust effort based on comfort; prioritize safety and rest.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Create a supportive sleep environment.',
              detail: 'Use cool, dark, quiet settings and supportive pillows.',
            },
            {
              text: 'Use side‑sleeping aids.',
              detail: 'Consider wedges or pregnancy pillows to support hips and back.',
            },
            {
              text: 'Respect naps and downtime.',
              detail: 'Plan short rest periods to manage energy and recovery.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Plan frequent breaks and hydration.',
              detail: 'Schedule short pauses and steady fluids to reduce strain.',
            },
            {
              text: 'Carry essentials and snacks.',
              detail: 'Keep documents, meds, and nutritious snacks accessible.',
            },
            {
              text: 'Consult before long trips.',
              detail: 'Seek guidance for extended travel and adjust plans accordingly.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Define preferences and contingencies.',
              detail: 'Outline desired approaches and backup plans for flexibility.',
            },
            {
              text: 'Share plan with support team.',
              detail: 'Ensure partner and professionals know preferences and roles.',
            },
            {
              text: 'Prepare hospital bag and documents.',
              detail: 'Pack essentials and organize paperwork ahead of time.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Arrange home support and supplies.',
              detail: 'Stock recovery items and plan assistance for care and chores.',
            },
            {
              text: 'Plan gentle recovery phases.',
              detail: 'Allow gradual return to activities with rest prioritized.',
            },
            {
              text: 'Coordinate pediatric care.',
              detail: 'Schedule early visits and prepare records for continuity.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Involve partner/family appropriately.',
              detail: 'Share tasks and expectations clearly to reduce stress.',
            },
            {
              text: 'Join trusted community groups.',
              detail: 'Seek moderated, evidence‑aligned spaces for guidance and connection.',
            },
            {
              text: 'Share updates and needs clearly.',
              detail: 'Communicate changes and requests to align support.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Follow recommended feeding intervals.',
              detail:
                'Use guidance from your pediatric provider; expect variability and respond to hunger cues.',
            },
            {
              text: 'Burp gently after feeds.',
              detail: 'Support head and neck; use light pats to release air and reduce discomfort.',
            },
            {
              text: 'Track intake patterns.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Use firm mattress; back sleeping.',
              detail: 'Place baby on their back on a firm, flat surface to reduce risk.',
            },
            {
              text: 'Keep crib clear of objects.',
              detail: 'Avoid pillows, blankets, and toys; use a fitted sheet only.',
            },
            {
        ...
        },
        {
          ...
          items: [
            {
              text: 'Gentle bathing and skincare.',
              detail: 'Use mild products; avoid over‑bathing to protect natural oils.',
            },
            {
              text: 'Frequent hand washing.',
              detail:
                'Wash hands before handling baby, after diaper changes, and when returning home.',
            },
            {
              text: 'Clean feeding tools thoroughly.',
              detail: 'Sterilize bottles/nipples per guidance; air‑dry on clean racks.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Change promptly; prevent rashes.',
              detail: 'Check often; use barrier creams as advised to protect skin.',
            },
            {
              text: 'Use gentle wipes or water.',
              detail: 'Prefer fragrance‑free options; pat dry to reduce irritation.',
            },
            {
              text: 'Dispose or wash safely.',
              detail: 'Seal disposables and launder cloth diapers per hygiene recommendations.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Swaddle safely; avoid overheating.',
              detail:
                'Use hip‑friendly wraps; ensure the face remains clear and breathing unimpeded.',
            },
            {
              text: 'Use rocking or white noise.',
              detail:
                'Gentle motion and consistent sound can calm; keep volume low and duration reasonable.',
            },
            {
              text: 'Maintain calm, low‑light environment.',
              detail: 'Dim lights and reduce stimulation to help settle and cue rest.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Track weight and growth.',
              detail:
                'Record measurements as provided; observe steady trends and discuss concerns.',
            },
            {
              text: 'Attend pediatric visits.',
              detail: 'Follow recommended schedule and prepare questions in advance.',
            },
            {
              text: 'Record vaccines and milestones.',
              detail: 'Keep an organized log for easy reference and care continuity.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Quiet, low‑stimulus space.',
              detail:
                'Limit loud sounds and bright lights; offer calm surroundings for rest and bonding.',
            },
            {
              text: 'Safe storage of supplies.',
              detail: 'Keep items within reach but secured; avoid clutter around sleep areas.',
            },
            {
              text: 'Sunlight exposure briefly and safely.',
              detail:
        ...
        },
        {
          ...
          items: [
            {
              text: 'Skin‑to‑skin time.',
              detail: 'Support warmth and connection; monitor comfort and positioning.',
            },
            {
              text: 'Gentle talking/singing.',
              detail: 'Soft voice and simple songs build familiarity and calm.',
            },
            {
              text: 'Respond promptly to cues.',
              detail: 'Observe signals (feeding, comfort, rest) and respond consistently.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Note fever, lethargy, breathing issues.',
              detail: 'Recognize urgent symptoms and seek prompt professional care.',
            },
            {
              text: 'Keep emergency contacts.',
              detail: 'Store key numbers visibly and on devices for quick access.',
            },
            {
              text: 'Follow professional guidance.',
              detail: 'Use advice from providers before attempting treatments or remedies.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Record feeds, diapers, sleep.',
              detail: 'Simple logs help reveal patterns for routines and care discussions.',
            },
            {
              text: 'Share log with caregivers.',
              detail: 'Provide clear handoffs to maintain consistency across helpers.',
            },
            {
              text: 'Use patterns to guide routines.',
              detail: 'Adjust timing and steps based on observed regularities.',
            },
          ],
        },
      ],
    ...
    'child-development': {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            {
              text: 'Use simple, safe toys.',
              detail:
                'Choose age‑appropriate items without small parts; favor open‑ended play for creativity.',
            },
            {
              text: 'Rotate activities for novelty.',
              detail: 'Cycle toys weekly to keep interest high without constant new purchases.',
            },
            {
              text: 'Encourage curiosity outdoors.',
              detail: 'Short, supervised outdoor time supports sensory learning and movement.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Read daily and narrate actions.',
              detail:
                'Describe routines and surroundings; language grows through frequent exposure.',
            },
            {
              text: 'Sing and rhyme for rhythm.',
              detail: 'Songs and rhymes support phonological awareness and memory.',
            },
            {
              text: 'Respond to sounds and words.',
              detail: 'Echo and expand child speech to model vocabulary and sentence patterns.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Practice crawling/walking safely.',
              detail:
                'Provide safe floor space, remove hazards, and let exploration lead the pace.',
            },
            {
              text: 'Fine motor with drawing/building.',
              detail: 'Offer chunky crayons, blocks, and simple tools to develop hand control.',
            },
            {
              text: 'Encourage varied movement.',
              detail: 'Mix reaching, climbing, and balance games to build coordination.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Model sharing and turn‑taking.',
              detail:
                'Demonstrate behaviors in calm interactions; children learn through observation.',
            },
            {
              text: 'Schedule gentle playtimes.',
              detail: 'Short, supervised sessions with peers build comfort and cooperation.',
            },
            {
              text: 'Teach empathy and kind speech.',
              detail: 'Label feelings and practice kind phrases to guide responses.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Balanced meals and snacks.',
              detail: 'Serve colorful plates with proteins, fruits/veggies, and whole grains.',
            },
            {
              text: 'Limit sugar and refined carbs.',
              detail: 'Favor steady energy options; reserve sweets for occasional treats.',
            },
            {
              text: 'Introduce diverse foods gradually.',
              detail: 'Offer small tastes of new foods repeatedly without pressure.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Age‑appropriate sleep schedules.',
              detail: 'Use typical ranges as a guide and adjust to the child’s cues.',
            },
            {
              text: 'Predictable wind‑down routines.',
              detail: 'Create calm sequences (bath, books, music) that signal bedtime.',
            },
            {
              text: 'Calm bedroom environment.',
              detail: 'Keep lights dim, noise low, and toys minimal around sleep areas.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Set age‑appropriate limits.',
              detail: 'Follow trusted recommendations; keep sessions short and purposeful.',
            },
            {
              text: 'Prefer co‑viewed, educational content.',
              detail: 'Watch together and discuss to turn viewing into learning.',
            },
            {
              text: 'Avoid screens near bedtime.',
              detail: 'Remove devices in the evening to protect sleep quality.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Childproof key areas.',
              detail: 'Secure outlets, cabinets, and cords; use gates near stairs.',
            },
            {
              text: 'Supervise near water and stairs.',
              detail: 'Maintain close supervision; avoid distractions during higher‑risk contexts.',
            },
            {
              text: 'Teach basic safety rules.',
              detail: 'Practice simple rules (hold hands, look both ways) through repetition.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Log milestones briefly.',
              detail:
                'Keep a simple record of new skills to spot patterns and share with caregivers.',
            },
            {
              text: 'Share updates with caregivers.',
              detail: 'Coordinate routines and expectations for consistency across settings.',
            },
            {
              text: 'Consult if concerns persist.',
              detail: 'Seek professional guidance when delays or behaviors cause ongoing worry.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Listen before advising.',
              detail:
                'Start with reflective listening to understand context and emotions before offering solutions.',
            },
            {
              text: 'Reflect feelings; clarify needs.',
              detail:
                'Name the emotion and ask simple questions to surface needs and reduce tension.',
            },
            {
              text: 'Use calm, simple language.',
              detail: 'Short sentences and neutral tone lower arousal and improve comprehension.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Define clear rules.',
              detail:
                'State expectations in positive terms and write them visibly for consistency.',
            },
            {
              text: 'Explain reasons and outcomes.',
              detail:
                'Briefly link rules to safety and respect; clarify natural outcomes of choices.',
            },
            {
              text: 'Be consistent and fair.',
              detail:
                'Apply rules predictably; adjust only with clear communication and rationales.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Morning/evening structure.',
              detail: 'Create simple sequences with visual aids to reduce decision load.',
            },
            {
              text: 'Visual schedules for clarity.',
              detail: 'Use icons or lists for steps; review together before transitions.',
            },
            {
              text: 'Include transitions and breaks.',
              detail: 'Add brief buffers between activities to prevent rush and meltdowns.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Praise effort and process.',
              detail: 'Focus on strategies and persistence to build growth mindset.',
            },
            {
              text: 'Use small rewards thoughtfully.',
              detail: 'Keep rewards modest and occasional; avoid dependency on prizes.',
            },
            {
              text: 'Celebrate small wins.',
              detail: 'Recognize progress promptly to reinforce desired behaviors.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Avoid harsh punishment.',
              detail: 'Harsh methods increase fear and resistance; prefer teaching approaches.',
            },
            {
              text: 'Use natural consequences.',
              detail: 'Let outcomes follow actions when safe to teach responsibility.',
            },
            {
              text: 'Model desired behavior.',
              detail: 'Demonstrate the behavior you expect; children imitate adult examples.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Align on rules and roles.',
              detail: 'Share a simple plan and divide responsibilities for a unified approach.',
            },
            {
              text: 'Share updates routinely.',
              detail: 'Use brief check‑ins to maintain context and prevent miscommunication.',
            },
            {
              text: 'Resolve conflicts privately.',
              detail: 'Discuss disagreements away from children to preserve stability.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Provide context and ask for simple strategies that can be mirrored at home.',
            },
            {
              text: 'Support homework routines.',
              detail: 'Define a consistent time and quiet space; use short focus blocks.',
            },
            {
              text: 'Attend meetings prepared.',
              detail:
                'Bring notes, examples, and goals to keep sessions focused and collaborative.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Age‑appropriate tasks.',
              detail: 'Match chores to abilities and teach steps patiently with demonstrations.',
            },
            {
              text: 'Pair chores with music or timers.',
              detail: 'Make tasks engaging and time‑bounded to improve follow‑through.',
            },
            {
              text: 'Rotate and track responsibilities.',
              detail: 'Use simple charts for fairness and visibility.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Name emotions and validate.',
              detail: 'Label feelings accurately and acknowledge them to reduce escalation.',
            },
            {
              text: 'Practice coping strategies.',
              detail: 'Teach breathing, breaks, and simple self‑talk when calm.',
            },
            {
              text: 'Build resilience gently.',
              detail: 'Set small challenges with support and praise recovery efforts.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Protect rest for caregivers.',
              detail: 'Plan downtime and sleep routines to sustain patience and clarity.',
            },
            {
              text: 'Ask for help early.',
              detail: 'Engage family, friends, or services before stress peaks.',
            },
            {
              text: 'Use community resources.',
              detail: 'Leverage local programs, groups, and hotlines for support and education.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Quiet, tidy workspace.',
              detail: 'Reduce noise and clutter; use a simple desk setup to lower distractions.',
            },
            {
              text: 'Consistent lighting and seating.',
              detail: 'Use comfortable seating and steady lighting that reduces eye strain.',
            },
            {
              text: 'Keep materials organized.',
              detail: 'Store pens, notebooks, and references within reach to avoid task switching.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Set start time and breaks.',
              detail:
                'Pick a daily start time and short breaks to build predictability and endurance.',
            },
            {
              text: 'Use timers to focus.',
              detail: 'Work in brief focus blocks (e.g., 20–30 minutes) with a visible timer.',
            },
            {
              text: 'Review and pack for next day.',
              detail: 'End with a 2–3 minute check to confirm tasks and prepare materials.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Schedule a consistent window; keep books visible to prompt the habit.',
            },
            {
              text: 'Choose engaging books.',
              detail: 'Select topics the child enjoys; balance challenge with confidence.',
            },
            {
              text: 'Discuss stories together.',
              detail:
                'Ask simple questions about characters, events, and ideas to deepen comprehension.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Observe preferences.',
              detail: 'Notice whether visual, auditory, or hands‑on explanations stick better.',
            },
            {
              text: 'Mix visual/auditory/kinesthetic.',
              detail:
                'Combine diagrams, talk‑throughs, and simple activities to reinforce learning.',
            },
            {
              text: 'Adapt explanations accordingly.',
              detail: 'Use the preferred style to clarify hard topics and maintain engagement.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Share context and goals.',
              detail:
                'Provide brief background and objectives to align support at school and home.',
            },
            {
              text: 'Track feedback and progress.',
              detail: 'Log notes from teacher updates; review monthly for patterns.',
            },
            {
              text: 'Schedule check‑ins.',
              detail: 'Set short, periodic meetings to adjust strategies collaboratively.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Review results calmly.',
              detail:
                'Go over outcomes without pressure; focus on understanding rather than fault.',
            },
            {
              text: 'Identify gaps and strengths.',
              detail: 'Highlight what went well and what needs practice to guide effort.',
            },
            {
              text: 'Plan targeted practice.',
              detail: 'Create short, focused exercises that address specific skill gaps.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Small, frequent sessions.',
              detail: 'Use short, regular practices to build skills steadily without fatigue.',
            },
            {
              text: 'Use scaffolding and examples.',
              detail: 'Model steps and provide worked examples before independent attempts.',
            },
            {
              text: 'Celebrate incremental gains.',
              detail: 'Acknowledge small improvements to sustain motivation.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Clubs and safe online resources.',
              detail: 'Join interest‑based groups or curated platforms that broaden skills.',
            },
            {
              text: 'Projects and hands‑on tasks.',
              detail: 'Encourage building, experiments, or creative work to apply learning.',
            },
            {
              text: 'Encourage curiosity.',
              detail: 'Invite questions and exploration; follow interests to deepen engagement.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Prepare schedules early.',
              detail: 'Plan study windows in advance; avoid cramming with realistic pacing.',
            },
            {
              text: 'Practice past questions.',
              detail: 'Use sample papers to build familiarity with formats and timing.',
            },
            {
              text: 'Teach test‑day routines.',
              detail: 'Sleep well, eat a simple meal, and pack essentials the night before.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Keep a simple log.',
              detail: 'Record brief notes on effort and outcomes to inform adjustments.',
            },
            {
              text: 'Share updates with caregivers.',
              detail: 'Coordinate across home and school for consistent support.',
            },
            {
              text: 'Adjust plans monthly.',
              detail: 'Refine routines and goals based on tracked progress and feedback.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Choose a tool or spreadsheet.',
              detail: 'Pick one simple system everyone can use; keep categories lean for clarity.',
            },
            {
              text: 'Define categories and caps.',
              detail: 'Set realistic limits based on past spending and current priorities.',
            },
            {
              text: 'Assign owners for tracking.',
              detail:
                'Designate responsibility per category to improve visibility and follow‑through.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Map pay dates and variability.',
              detail: 'Plot salaries, freelance income, and timing to anticipate cash flow.',
            },
            {
              text: 'Plan buffers for irregulars.',
              detail: 'Hold a small reserve to smooth variable or seasonal income.',
            },
            {
              text: 'Document sources clearly.',
              detail: 'List each source and typical amounts; note dependencies or risks.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Separate fixed and variable.',
              detail:
                'Identify non‑negotiables (rent, utilities) versus flexible (dining, entertainment).',
            },
            {
              text: 'Identify discretionary areas.',
              detail: 'Spot categories with room to trim; set guidelines rather than bans.',
            },
            {
              text: 'Set alerts for overspend.',
              detail: 'Use app rules or manual checks to flag when categories approach caps.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Short‑, mid‑, long‑term goals.',
              detail:
                'Define timelines and amounts for near needs, upcoming plans, and future security.',
            },
            {
              text: 'Automate transfers.',
              detail: 'Schedule small, regular moves to savings to reduce decision friction.',
            },
            {
              text: 'Use labeled accounts.',
              detail:
                'Name sub‑accounts (travel, school, repairs) to keep goals visible and motivating.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Target 3–6 months baseline.',
              detail:
                'Aim for core expenses coverage; start with a modest target and grow steadily.',
            },
            {
              text: 'Start small and grow.',
              detail:
                'Begin with micro‑savings; increase contributions after debts or bills improve.',
            },
            {
              text: 'Keep accessible but separate.',
              detail: 'Store funds where they are safe and liquid but not in spend accounts.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'List balances and rates.',
              detail: 'Create a clear inventory to prioritize high‑interest accounts.',
            },
            {
              text: 'Choose snowball or avalanche.',
              detail:
                'Snowball builds momentum; avalanche saves interest—pick what sustains consistency.',
            },
            {
              text: 'Avoid new high‑interest debt.',
              detail: 'Use spending rules and buffers to prevent adding costly balances.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Use 24‑hour pause for big buys.',
              detail: 'Delay large purchases to reduce impulse decisions and regret.',
            },
            {
              text: 'Limit impulse categories.',
              detail: 'Cap flexible areas (e.g., dining out) and track weekly rather than monthly.',
            },
            {
              text: 'Prefer planned purchases.',
              detail: 'Batch buying decisions; use lists aligned with goals to stay focused.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Hold monthly reviews.',
              detail:
                'Review spending, goals, and adjustments together; keep sessions short and calm.',
            },
            {
              text: 'Set shared priorities.',
              detail: 'Agree on top goals and tradeoffs to reduce friction in daily choices.',
            },
            {
              text: 'Teach kids simple money habits.',
              detail:
                'Model saving, thoughtful spending, and delayed gratification with small examples.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Budget apps or shared docs.',
              detail: 'Use a shared platform for visibility and easy updates.',
            },
            {
              text: 'Alerts and dashboards.',
              detail: 'Enable notifications and quick views to catch issues early.',
            },
            {
              text: 'Backup data regularly.',
              detail: 'Export or sync data to avoid loss and maintain continuity.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Quarterly goal checks.',
              detail: 'Assess progress and adjust targets based on real outcomes.',
            },
            {
              text: 'Adjust caps realistically.',
              detail: 'Change category limits when life or prices shift; avoid rigid adherence.',
            },
            {
              text: 'Celebrate milestones.',
              detail: 'Acknowledge achievements to keep motivation strong and habits durable.',
            },
          ],
        },
      ],
    ...
    'home-routines': {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            {
              text: 'Snack and decompress.',
              detail: 'Offer a healthy snack and 10–15 minutes of calm time before work blocks.',
            },
            {
              text: 'Homework window and breaks.',
              detail: 'Use short focus blocks with brief breaks to maintain energy and attention.',
            },
            {
              text: 'Pack for tomorrow.',
              detail: 'Check assignments and prepare materials before evening wind‑down.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Batch cooking weekly.',
              detail: 'Cook staple components once and portion for quick, healthy meals.',
            },
            {
              text: 'Shared recipe board.',
              detail: 'Keep a visible list of go‑to meals and ingredients to speed decisions.',
            },
            {
              text: 'Rotate menus for variety.',
              detail: 'Use simple theme nights to avoid choice fatigue.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Assign age‑appropriate tasks.',
              detail: 'Match chores to ability and teach steps patiently with demonstrations.',
            },
            {
              text: 'Use timers and music.',
              detail: 'Run 10‑minute sprints with music to make tasks engaging and time‑bounded.',
            },
            {
              text: 'Track progress visibly.',
              detail: 'Use charts or checklists on the fridge for fairness and motivation.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Plan errands and rest.',
              detail: 'Make a short list and block downtime to prevent over‑scheduling.',
            },
            {
              text: 'Schedule family activities.',
              detail: 'Choose simple outings that fit energy and budget constraints.',
            },
            {
              text: 'Keep buffer for spontaneity.',
              detail: 'Leave open windows to adapt plans and avoid rush.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Hydration and movement.',
              detail: 'Set specific times for water and short movement breaks across the day.',
            },
            {
              text: 'Light outdoor time.',
              detail: 'Use brief walks or balcony time for natural light and fresh air.',
            },
            {
              text: 'Simple mindfulness blocks.',
              detail: 'Add 5‑minute breathing or quiet time to reduce stress.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Consistent wind‑down.',
              detail: 'Create a calm sequence (tidy, hygiene, books) that signals bedtime.',
            },
            {
              text: 'Tech off earlier.',
              detail: 'Park devices outside bedrooms and shift to warm lighting before sleep.',
            },
            {
              text: 'Calm bedroom setup.',
              detail: 'Keep lights dim, noise low, and surfaces clear to support rest.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Set simple rules for daily totals and content types.',
            },
            {
              text: 'Co‑view educational content.',
              detail: 'Watch together and discuss to turn viewing into learning.',
            },
            {
              text: 'Device charging station.',
              detail: 'Charge devices in a common area to reduce bedtime disruption.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Keep events and tasks synced and visible for all.',
            },
            {
              text: 'Visual schedules for kids.',
              detail: 'Use icons and color coding for clarity and buy‑in.',
            },
            {
              text: 'Weekly review ritual.',
              detail: 'Hold a short Sunday check‑in to adjust plans and confirm priorities.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Revise routines each month.',
              detail: 'Tweak steps based on what actually works rather than sticking rigidly.',
            },
            {
              text: 'Retire friction points.',
              detail: 'Remove or redesign steps that repeatedly cause delay or stress.',
            },
            {
              text: 'Keep changes small and steady.',
              detail: 'Implement one change at a time and stabilize before adding more.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'List trusted local clinics.',
              detail:
                'Compile verified providers with addresses and contact details for quick access.',
            },
            {
              text: 'Note specialties and hours.',
              detail: 'Record areas of expertise and opening times to match needs efficiently.',
            },
            {
              text: 'Keep contacts updated.',
              detail: 'Review entries quarterly; remove outdated info and add new options.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Emergency and support numbers.',
              detail: 'Store national/local emergency and counseling lines prominently.',
            },
            {
              text: 'Store visibly and digitally.',
              detail: 'Post on the fridge and save in phones for immediate retrieval.',
            },
            {
              text: 'Practice usage scenarios.',
              detail: 'Discuss when and how to call so family members feel prepared.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Evidence‑based titles.',
              detail: 'Favor resources aligned with reputable organizations and current research.',
            },
            {
              text: 'Summaries and key ideas.',
              detail: 'Create brief notes to recall concepts without re‑reading entire books.',
            },
            {
              text: 'Library and online options.',
              detail: 'Use library holds and credible online repositories to reduce costs.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Trackers and education apps.',
              detail: 'Choose tools that simplify routines or teach skills without heavy ads.',
            },
            {
              text: 'Privacy and safety checks.',
              detail: 'Review permissions, data policies, and content ratings before adoption.',
            },
            {
              text: 'Share setup tips.',
              detail: 'Document configurations and usage best practices for caregivers.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Local/community groups.',
              detail: 'Join nearby meetups or community centers for in‑person support.',
            },
            {
              text: 'Online moderated spaces.',
              detail: 'Prefer moderated forums to maintain safety and constructive dialogue.',
            },
            {
              text: 'Meeting schedules.',
              detail: 'Track times, locations, and agendas to plan attendance smoothly.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Parenting classes or webinars.',
              detail: 'Select courses with clear outcomes and practical exercises.',
            },
            {
              text: 'Age‑specific modules.',
              detail: 'Match material to developmental stages for relevance.',
            },
            {
              text: 'Certificates and follow‑ups.',
              detail: 'Save completion records and schedule refreshers if offered.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Health and education support.',
              detail: 'Identify benefits, screenings, and services available locally.',
            },
            {
              text: 'Documentation requirements.',
              detail: 'List required IDs, forms, and proofs to prevent application delays.',
            },
            {
              text: 'Application timelines.',
              detail: 'Note deadlines and processing windows to plan appropriately.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Emergency kits.',
              detail: 'Prepare supplies, contacts, and plans; review seasonally.',
            },
            {
              text: 'Care logs and schedules.',
              detail: 'Use simple templates to coordinate caregivers and track routines.',
            },
            {
              text: 'School readiness lists.',
              detail: 'Organize documents, supplies, and health checks ahead of term.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Budget sheets.',
              detail: 'Provide simple tables for income, expenses, and goals.',
            },
            {
              text: 'Routine planners.',
              detail: 'Offer daily/weekly layouts to standardize blocks and transitions.',
            },
            {
              text: 'Meal plans and chore charts.',
              detail: 'Use clear grids to assign tasks and plan balanced menus.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Review and update quarterly.',
              detail: 'Audit links and materials; verify accuracy and relevance.',
            },
            {
              text: 'Gather feedback from users.',
              detail: 'Ask caregivers what helped and what needs improvement.',
            },
            {
              text: 'Archive outdated resources.',
              detail: 'Retire obsolete content to keep the library clean and trusted.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Define purpose and must‑see items.',
              detail: 'Choose themes and top experiences to guide route, pacing, and budget.',
            },
            {
              text: 'Estimate time windows.',
              detail: 'Plan realistic days with rest; avoid over‑stacking activities.',
            },
            {
              text: 'Align with companions.',
              detail: 'Capture preferences, constraints, and energy levels for shared buy‑in.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Confirm at least 6 months remaining beyond your return date.',
            },
            {
              text: 'Visas and entry requirements.',
              detail: 'Use official sources to verify visas, e‑visas, and permits.',
            },
            {
              text: 'Travel insurance confirmation.',
              detail: 'Ensure medical, cancellation, and baggage coverage are active.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'List essentials by category and climate to prevent last‑minute stress.',
            },
            {
              text: 'Pack light and versatile.',
              detail: 'Favor layers and multi‑use items; keep bag size within easy carry limits.',
            },
            {
              text: 'Include basic meds and chargers.',
              detail: 'Add first‑aid basics, prescriptions, adapters, and power banks.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Map daily highlights.',
              detail: 'Choose 1–2 anchors per day and let extras be optional.',
            },
            {
              text: 'Group nearby attractions.',
              detail: 'Cluster by neighborhoods to reduce transit time and fatigue.',
            },
            {
              text: 'Add buffer time.',
              detail: 'Leave 20–30% flexible time for delays or spontaneous finds.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Set caps per category.',
              detail: 'Assign limits for lodging, food, transport, and activities.',
            },
            {
              text: 'Track real‑time spend.',
              detail: 'Use an app or shared sheet to update costs daily.',
            },
            {
              text: 'Keep emergency buffer.',
              detail: 'Hold a small reserve for unexpected expenses or changes.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Save embassy, local clinics, and trusted contacts in phones.',
            },
            {
              text: 'Save local hotlines.',
              detail: 'Record police, medical, and tourist assistance numbers.',
            },
            {
              text: 'Share itinerary with someone.',
              detail: 'Provide check‑in times and route changes to a contact at home.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Book flights or routes early.',
              detail: 'Secure better schedules and pricing with advance booking.',
            },
            {
              text: 'Compare options for value.',
              detail: 'Balance cost against time and convenience for each leg.',
            },
            {
              text: 'Plan airport/city transfers.',
              detail: 'Decide on trains, buses, or rides; note pickup points and timings.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Pick location near transit.',
              detail: 'Choose walkable areas or close to lines for easy movement.',
            },
            {
              text: 'Check reviews and safety.',
              detail: 'Read recent, balanced reviews; verify neighborhood safety.',
            },
            {
              text: 'Confirm cancellation policies.',
              detail: 'Prefer flexible options if plans may change.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Learn basic phrases.',
              detail: 'Practice greetings, directions, and polite forms for smoother interactions.',
            },
            {
              text: 'Know customs and etiquette.',
              detail: 'Understand dress, table manners, and public behavior norms.',
            },
            {
              text: 'Understand tipping and fees.',
              detail: 'Check expected gratuities and typical service charges.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Note highlights and friction points to refine future plans.',
            },
            {
              text: 'Archive receipts.',
              detail: 'Store records for budgeting, reimbursements, or claims.',
            },
            {
              text: 'Note improvements for next time.',
              detail: 'Update packing lists, routes, and vendor choices based on experience.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Set total cap.',
              detail: 'Define an overall trip limit and stick to it with daily guardrails.',
            },
            {
              text: 'Allocate by category.',
              detail: 'Distribute funds across lodging, food, transport, and activities.',
            },
            {
              text: 'Track daily spend.',
              detail: 'Log costs each day to adjust quickly when a category runs hot.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Flexible dates for deals.',
              detail: 'Search ±3–7 days; use fare calendars to spot cheaper windows.',
            },
            {
              text: 'Use alerts and points.',
              detail: 'Set price alerts; redeem miles or flexible points for big savings.',
            },
            {
              text: 'Avoid peak seasons.',
              detail: 'Prefer shoulder periods and midweek departures to cut costs.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Compare hostels and rentals.',
              detail: 'Balance privacy, location, and shared amenities for value.',
            },
            {
              text: 'Choose shared spaces or kitchens.',
              detail: 'Access to kitchens reduces food costs and increases flexibility.',
            },
            {
              text: 'Check weekly rates.',
              detail: 'Longer stays often unlock discounted nightly pricing.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Local markets and street food.',
              detail: 'Eat where locals eat; prioritize fresh, simple dishes.',
            },
            {
              text: 'Cook simple meals.',
              detail: 'Prepare breakfasts or one meal daily to trim expenses.',
            },
            {
              text: 'Avoid tourist traps.',
              detail: 'Skip venues near main attractions; compare menus a block away.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Buy day passes or reloadable cards for predictable, low fares.',
            },
            {
              text: 'Walk or cycle when possible.',
              detail: 'Plan short routes to save money and discover neighborhoods.',
            },
            {
              text: 'Buy passes to save.',
              detail: 'Weekly or multi‑ride tickets reduce per‑trip costs.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Free museums and parks.',
              detail: 'Target free days and public spaces for rich experiences.',
            },
            {
              text: 'City walking tours.',
              detail: 'Use tip‑based tours to learn history affordably.',
            },
            {
              text: 'Bundle tickets.',
              detail: 'City passes or combo tickets can lower total spend.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Travel shoulder seasons.',
              detail: 'Lower prices, fewer crowds, and better availability.',
            },
            {
              text: 'Visit weekdays.',
              detail: 'Aim for Tuesday–Thursday to avoid weekend premiums.',
            },
            {
              text: 'Time visits early or late.',
              detail: 'Arrive off hours to reduce lines and dynamic pricing.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Use loyalty programs.',
              detail: 'Enroll in airline, hotel, and transit schemes for perks.',
            },
            {
              text: 'Collect miles/points.',
              detail: 'Pay with cards that earn transferable points for flexibility.',
            },
            {
              text: 'Leverage cashback.',
              detail: 'Stack cashback portals and card offers on bookings.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Protect documents and cash.',
              detail: 'Carry copies and split storage; use money belts discreetly.',
            },
            {
              text: 'Beware common scams.',
              detail: 'Research local tactics; confirm prices before service.',
            },
            {
              text: 'Keep emergency numbers.',
              detail: 'Save medical, police, and embassy contacts offline.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Track savings.',
              detail: 'Compare planned vs actual costs; note standout wins.',
            },
            {
              text: 'Note best value tips.',
              detail: 'Record tactics that worked to reuse on future trips.',
            },
            {
              text: 'Plan future optimizations.',
              detail: 'Refine packing, routes, and booking strategies iteratively.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Research local risks.',
              detail: 'Check government advisories and recent news on safety, weather, and events.',
            },
            {
              text: 'Share plans with contacts.',
              detail: 'Provide itinerary and check‑in schedule to someone you trust.',
            },
            {
              text: 'Backup documents digitally.',
              detail: 'Store scans of passports, visas, and policies in secure cloud storage.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Vaccinations and meds.',
              detail: 'Confirm required shots and carry prescriptions with generic names.',
            },
            {
              text: 'Travel clinic advice.',
              detail: 'Consult professionals for region‑specific precautions and kits.',
            },
            {
              text: 'Pack first‑aid essentials.',
              detail:
                'Include pain relief, bandages, antiseptic, rehydration salts, and allergy meds.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Copies of ID and visas.',
              detail: 'Keep printed and digital copies separate from originals.',
            },
            {
              text: 'Emergency contacts list.',
              detail: 'Record embassy, local health providers, and personal contacts.',
            },
            {
              text: 'Secure storage.',
              detail: 'Use hotel safes or hidden pouches; avoid carrying all documents at once.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Choose reputable providers.',
              detail: 'Book verified taxis, trains, and buses; check ratings and licenses.',
            },
            {
              text: 'Avoid risky routes/times.',
              detail: 'Prefer daylight travel; ask locals about safer paths.',
            },
            {
              text: 'Seatbelts and helmets.',
              detail: 'Buckle up and wear helmets; decline unsafe vehicles.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Well‑reviewed areas.',
              detail: 'Pick neighborhoods with consistent positive feedback on safety.',
            },
            {
              text: 'Locks and safes.',
              detail: 'Check room locks; use safes for valuables or lockable bags.',
            },
            {
              text: 'Know exits and rules.',
              detail: 'Locate exits, alarms, and house rules upon arrival.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Limit cash carry.',
              detail: 'Carry only what you need; keep reserves in separate places.',
            },
            {
              text: 'Use cards carefully.',
              detail: 'Enable transaction alerts; avoid public Wi‑Fi for banking.',
            },
            {
              text: 'Hide backups and split storage.',
              detail: 'Separate cards/cash across bags and pockets to reduce single‑point loss.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Local SIM or eSIM.',
              detail: 'Stay reachable and access maps and translation on the go.',
            },
            {
              text: 'Emergency dialing codes.',
              detail: 'Note country‑specific codes and quick‑dial contacts.',
            },
            {
              text: 'Share live location.',
              detail: 'Use trusted apps to let contacts track your movements when needed.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Understand restrictions.',
              detail: 'Check rules on medications, drones, and photography.',
            },
            {
              text: 'Respect customs.',
              detail: 'Adapt dress and behavior to local norms to avoid conflict.',
            },
            {
              text: 'Avoid prohibited items.',
              detail: 'Confirm bans on foods, plants, or cultural artifacts.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Nearest clinics and police.',
              detail: 'Map locations and routes before you need them.',
            },
            {
              text: 'Insurance claim steps.',
              detail: 'Know documentation required and the process to file quickly.',
            },
            {
              text: 'Contingency contacts.',
              detail: 'Keep backups for transportation, lodging, and local assistance.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Debrief incidents.',
              detail: 'Record what happened and lessons learned to improve future safety.',
            },
            {
              text: 'Update checklists.',
              detail: 'Revise packing and procedures based on real‑world gaps.',
            },
            {
              text: 'Adjust future plans.',
              detail: 'Change routes, vendors, or policies to reduce similar risks next time.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Hotels and hostels.',
              detail:
                'Pick based on budget, privacy, and services; hostels suit social, low‑cost travel.',
            },
            {
              text: 'Apartments and homestays.',
              detail: 'Gain kitchens and space; confirm building rules and access details.',
            },
            {
              text: 'Unique stays.',
              detail: 'Consider cabins or boutique options; verify amenities match your needs.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Check multiple sites for price, policies, and included services.',
            },
            {
              text: 'Check policies and fees.',
              detail: 'Read cancellation, deposits, and cleaning fees to avoid surprises.',
            },
            {
              text: 'Use filters wisely.',
              detail: 'Filter for location, rating, and essentials (Wi‑Fi, kitchen, AC).',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Near transit and attractions.',
              detail: 'Reduce commute time; pick walkable areas aligned with itinerary.',
            },
            {
              text: 'Safe neighborhoods.',
              detail: 'Scan recent reviews and local guidance for safety signals.',
            },
            {
              text: 'Noise considerations.',
              detail: 'Ask about street noise, clubs, or construction; request quiet rooms.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Kitchen and laundry.',
              detail: 'Save on food and packing; confirm appliances and availability.',
            },
            {
              text: 'Wi‑Fi reliability.',
              detail: 'Check speed reports; contact host for typical speeds and outages.',
            },
            {
              text: 'Workspace needs.',
              detail: 'Ensure desk space, outlets, and lighting if you plan to work.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Locks and security.',
              detail: 'Verify door locks, secondary latches, and building access controls.',
            },
            {
              text: 'Emergency exits.',
              detail: 'Locate exits and alarms; know procedures in case of incident.',
            },
            {
              text: 'Host verification.',
              detail: 'Prefer verified hosts and platforms with strong fraud protections.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Total cost and deposits.',
              detail: 'Calculate full stay cost including cleaning, taxes, and deposits.',
            },
            {
              text: 'Weekly/monthly discounts.',
              detail: 'Longer bookings often reduce nightly rates significantly.',
            },
            {
              text: 'Hidden fees.',
              detail: 'Ask about parking, resort, or key replacement fees before booking.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Arrival times and access.',
              detail: 'Confirm check‑in windows and keys, codes, or staff availability.',
            },
            {
              text: 'ID requirements.',
              detail: 'Carry necessary identification per platform or local regulation.',
            },
            {
              text: 'House rules.',
              detail: 'Understand guest limits, noise, smoking, and pet policies in advance.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Guests and noise.',
              detail: 'Respect quiet hours and capacity limits to avoid penalties.',
            },
            {
              text: 'Cleaning expectations.',
              detail: 'Clarify chores and checkout steps to prevent extra fees.',
            },
            {
              text: 'Local regulations.',
              detail: 'Follow building and city rules for short‑term stays.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Recent, balanced feedback.',
              detail: 'Read multiple recent reviews to catch changes in quality.',
            },
            {
              text: 'Read negatives.',
              detail: 'Assess consistent complaints (noise, cleanliness) before committing.',
            },
            {
              text: 'Photos vs reality.',
              detail: 'Compare traveler photos with listings to spot misleading angles.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Contact host early.',
              detail: 'Report issues promptly to allow fixes or adjustments.',
            },
            {
              text: 'Document issues.',
              detail: 'Take photos and notes; communicate through the platform for records.',
            },
            {
              text: 'Relocation options.',
              detail: 'Know backup stays or platform support if problems persist.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Transit, rides, bikes.',
              detail: 'Choose modes per distance, cost, and safety; mix for efficiency.',
            },
            {
              text: 'Compare options.',
              detail: 'Balance price vs time; consider transfers and wait times.',
            },
            {
              text: 'Accessibility needs.',
              detail: 'Verify lifts, ramps, and accessible vehicles before travel.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Apps and passes.',
              detail: 'Install local apps; buy day or weekly passes for savings.',
            },
            {
              text: 'Advance tickets.',
              detail: 'Reserve intercity routes early for schedules and better fares.',
            },
            {
              text: 'Flexible options.',
              detail: 'Prefer refundable or changeable tickets when plans may shift.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Stay alert.',
              detail: 'Keep valuables secured; avoid distraction in crowded areas.',
            },
            {
              text: 'Verified providers.',
              detail: 'Use licensed rides and official stations to reduce risk.',
            },
            {
              text: 'Night travel rules.',
              detail: 'Choose well‑lit routes; sit near staff or exits when possible.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Maps and lines.',
              detail: 'Learn key lines and transfer points to simplify navigation.',
            },
            {
              text: 'Peak times.',
              detail: 'Avoid rush hours when possible; plan buffers for delays.',
            },
        ...
        },
        {
          ...
          items: [
            {
              text: 'Official stands.',
              detail: 'Board at marked areas; confirm driver and car details.',
            },
            {
              text: 'License checks.',
              detail: 'Verify permit and meter; agree on fare for non‑metered rides.',
            },
            {
              text: 'Upfront pricing.',
              detail: 'Use apps with upfront fares; avoid cash‑only surprises.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Check license requirements and ensure proper coverage.',
            },
            {
              text: 'Local laws.',
              detail: 'Learn speed limits, alcohol rules, and right‑of‑way norms.',
            },
            {
              text: 'Parking and tolls.',
              detail: 'Plan for parking costs and toll routes to avoid fines.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Routes and paths.',
              detail: 'Pick pedestrian‑friendly areas and protected bike lanes.',
            },
            {
              text: 'Lights and helmets.',
              detail: 'Carry lights at night and wear helmets for safety.',
            },
        ...
        },
        {
          ...
          items: [
            {
              text: 'Elevators and ramps.',
              detail: 'Confirm station and vehicle accessibility features.',
            },
            {
              text: 'Priority seating.',
              detail: 'Know policies and ask staff for assistance when needed.',
            },
            {
              text: 'Service availability.',
              detail: 'Check for outages or reduced services before setting out.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Use lockers or hotel storage to reduce burden in city visits.',
            },
            {
              text: 'Weight and size limits.',
              detail: 'Follow carrier rules to avoid extra fees and delays.',
            },
            {
              text: 'Label bags.',
              detail: 'Add contact info and markers to speed identification.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Prepare backups for closures or delays to maintain schedule.',
            },
            {
              text: 'Delay buffers.',
              detail: 'Add time between connections to absorb disruptions.',
            },
            {
              text: 'Local contacts.',
              detail: 'Save numbers for stations, vendors, or friends who can assist.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Right to reside.',
              detail: 'Confirm residency status and permitted activities before arrival.',
            },
            {
              text: 'Work/study permits.',
              detail: 'Apply early; track requirements and processing times.',
            },
            {
              text: 'Renewals and compliance.',
              detail: 'Set reminders; keep copies of filings and approvals.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Neighborhood research.',
              detail: 'Assess safety, transit, and grocery access; visit at different times.',
            },
            {
              text: 'Lease terms.',
              detail: 'Review deposits, notice periods, and maintenance responsibilities.',
            },
            {
              text: 'Utilities and setup.',
              detail: 'Arrange power, water, internet, and waste services quickly.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Local accounts.',
              detail: 'Open checking and savings; confirm ID and address requirements.',
            },
            {
              text: 'Transfers & fees.',
              detail: 'Compare wire, ACH, and card fees; use low‑cost providers.',
            },
        ...
        },
        {
          ...
          items: [
            {
              text: 'Insurance and clinics.',
              detail: 'Enroll in appropriate plans; list nearby clinics and hospitals.',
            },
            {
              text: 'Registration steps.',
              detail: 'Complete local health registrations if required.',
            },
            {
              text: 'Pharmacies.',
              detail: 'Locate reliable pharmacies; learn prescription transfer rules.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Classes and apps.',
              detail: 'Use formal courses and daily practice apps for acceleration.',
            },
            {
              text: 'Local practice.',
              detail: 'Join conversation groups; practice in low‑stakes settings.',
            },
            {
              text: 'Key survival phrases.',
              detail: 'Master basics for directions, shopping, and emergencies.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Contracts and rules.',
              detail: 'Understand terms, probation periods, and grievance processes.',
            },
            {
              text: 'Schedules and holidays.',
              detail: 'Map public holidays and typical work hours to plan well.',
            },
            {
              text: 'Support offices.',
              detail: 'Identify HR/international offices for onboarding help.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Join local communities for interests and support.',
            },
            {
              text: 'Mentors and support.',
              detail: 'Find guides who share practical advice and connections.',
            },
        ...
        },
        {
          ...
          items: [
            {
              text: 'Local risks.',
              detail: 'Research neighborhood‑specific risks and emergency services.',
            },
            {
              text: 'Secure habits.',
              detail: 'Adopt routines for locking, lighting, and travel awareness.',
            },
            {
              text: 'Emergency plans.',
              detail: 'Create contacts, meeting points, and backup housing options.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Etiquette and norms.',
              detail: 'Learn greetings, queue rules, and social expectations.',
            },
            {
              text: 'Food and festivals.',
              detail: 'Explore local cuisine and calendar events respectfully.',
            },
            {
              text: 'Dress and customs.',
              detail: 'Adapt attire to context; understand religious considerations.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Transport and phones.',
              detail: 'Choose plans and passes; set up local SIM or eSIM.',
            },
            {
              text: 'Mailing and IDs.',
              detail: 'Register addresses; obtain resident IDs as required.',
            },
            {
              text: 'Cost of living.',
              detail: 'Track expenses and adjust budgets to local prices.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Greetings and gestures.',
              detail: 'Use local forms of address and respectful body language.',
            },
            {
              text: 'Queueing and lines.',
              detail: 'Follow local norms for order and spacing; avoid cutting.',
            },
            {
              text: 'Dining manners.',
              detail: 'Learn utensil use, hand rules, and serving customs.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Direct vs indirect styles.',
              detail: 'Adjust tone to local preference; avoid confrontational phrasing.',
            },
            {
              text: 'Volume and space.',
              detail: 'Match typical speaking volume and personal distance.',
            },
            {
              text: 'Honorifics.',
              detail: 'Use titles and polite forms appropriately, especially with elders.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Common staples.',
              detail: 'Learn typical dishes to order confidently and respectfully.',
            },
            {
              text: 'Religious rules.',
              detail: 'Respect dietary restrictions and preparation customs.',
            },
            {
              text: 'Allergies and substitutions.',
              detail: 'Communicate needs clearly; carry translations if necessary.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Places of worship rules.',
              detail: 'Follow dress, entry, and photography guidelines; remain discreet.',
            },
            {
              text: 'Dress expectations.',
              detail: 'Adapt attire to modesty and occasion standards.',
            },
            {
              text: 'Photography guidance.',
              detail: 'Ask permission and avoid restricted areas or sacred objects.',
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: 'Event attire.',
              detail: 'Choose appropriate outfits for ceremonies and formal events.',
            },
            {
              text: 'Practical choices.',
              detail: 'Prioritize comfort and climate‑appropriate fabrics.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Receiving and giving.',
              detail: 'Use both hands where customary; avoid opening immediately if not expected.',
            },
            {
              text: 'Avoid faux pas.',
              detail: 'Check items or colors considered unlucky or inappropriate.',
            },
            {
              text: 'Wrapping styles.',
              detail: 'Follow local wrapping traditions and presentation etiquette.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Ask permission.',
              detail: 'Gain consent for portraits; respect privacy and cultural norms.',
            },
            {
              text: 'Restricted sites.',
              detail: 'Follow rules at government or religious locations.',
            },
            {
              text: 'Discretion and respect.',
              detail: 'Avoid disruption and remain sensitive to context.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Bargaining norms.',
              detail: 'Learn where haggling is expected and typical discount ranges.',
            },
            {
              text: 'Fair pricing.',
              detail: 'Aim for reasonable outcomes; avoid aggressive tactics.',
            },
          ...
          items: [
            {
              ...
              detail: 'Understand local flexibility versus strict schedules.',
            },
            {
              text: 'Grace periods.',
              detail: 'Offer and expect small buffers; communicate proactively.',
            },
        ...
        },
        {
          ...
          items: [
            {
              text: 'Learn local phrases.',
              detail: 'Use basic language to show effort and build goodwill.',
            },
            {
              text: 'Avoid stereotypes.',
              detail: 'Stay curious and open; ask questions rather than assume.',
            },
            {
              text: 'Be curious and humble.',
              detail: 'Listen actively and follow local leads on behavior.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Respectful forms of address.',
              detail: 'Use titles and honorifics; greet elders first with deference.',
            },
            {
              text: 'Handshakes and bows.',
              detail:
                'Offer firm but polite handshakes; slight bows show respect in some contexts.',
            },
            {
              text: 'Elders first.',
              detail: 'Prioritize elders in greetings and seating; avoid interrupting.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Staples and dishes.',
              detail: 'Know jollof, suya, pounded yam, egusi; try local variations.',
            },
            {
              text: 'Street food etiquette.',
              detail: 'Buy from busy, clean vendors; watch handling and reheating.',
            },
            {
              text: 'Regional flavors.',
              detail: 'Explore differences across regions for spice levels and ingredients.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Bargaining norms.',
              detail: 'Expect negotiation; start low, remain friendly, and settle fairly.',
            },
            {
              text: 'Cash vs transfers.',
              detail: 'Carry small bills; many vendors accept mobile transfers.',
            },
            {
              text: 'Safety tips.',
              detail: 'Keep valuables hidden; travel with companions where possible.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Popular genres.',
              detail: 'Afrobeats, highlife, and fuji are widely enjoyed; check local charts.',
            },
            {
              text: 'Local venues.',
              detail: 'Attend open‑air shows or cultural centers for authentic experiences.',
            },
            {
              text: 'Etiquette at events.',
              detail: 'Respect performance space; ask before filming or photographing.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Major celebrations.',
              detail: 'Note Eyo, Durbar, and cultural harvests; confirm schedules and routes.',
            },
            {
              text: 'Dress expectations.',
              detail: 'Wear comfortable, respectful attire; consider traditional fabrics.',
            },
            {
              text: 'Community roles.',
              detail: 'Observe roles and protocols; follow local guidance during processions.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              detail: 'Ankara, agbada, and gele feature prominently; ask for styling help.',
            },
            {
              text: 'Modesty and comfort.',
              detail: 'Adapt to climate and setting; carry light layers for sun.',
            },
            {
              text: 'Occasion specifics.',
              detail: 'Match attire to weddings, church, or official events appropriately.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Danfo and keke tips.',
              detail: 'Learn routes and fares; board at official stops when possible.',
            },
            {
              text: 'Routes and hubs.',
              detail: 'Identify major terminals and typical interchange points.',
            },
            {
              text: 'Safety at night.',
              detail: 'Prefer ride‑hailing and well‑lit roads; share trips with contacts.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Stay aware.',
              detail: 'Watch surroundings; avoid displaying valuables; plan routes in advance.',
            },
            {
              text: 'Local contacts.',
              detail: 'Save trusted numbers for quick assistance or advice.',
            },
            {
              text: 'Emergency numbers.',
              detail: 'Record police, medical, and fire services for your area.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Common phrases.',
              detail: 'Learn greetings in Yoruba, Igbo, Hausa, and Pidgin for connection.',
            },
            {
              text: 'Regional languages.',
              detail: 'Expect multilingual environments; ask politely which language to use.',
            },
            {
              text: 'Polite forms.',
              detail: 'Use courteous expressions; avoid slang until you understand context.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'When and how.',
              detail: 'Tip for good service where customary; ask locals for norms.',
            },
            {
              text: 'Fair pricing.',
              detail: 'Negotiate respectfully; accept small overages as goodwill when needed.',
            },
            {
              text: 'Polite refusals.',
              detail: 'Decline extra purchases with warm but firm language.',
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              text: 'Attractions and hours.',
              detail: 'Confirm opening times and closures; check seasonal highlights.',
            },
            { text: 'Best times.', detail: 'Visit early or late to avoid crowds and heat.' },
            {
              text: 'Local rules.',
              detail: 'Learn restrictions on food, pets, and drones before visiting.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Routes and clusters.',
              detail: 'Group nearby sites to maximize time at attractions.',
            },
            {
              text: 'Buffer times.',
              detail: 'Add breaks and transit margins to keep the day calm.',
            },
        ...
        },
        {
          ...
          items: [
            {
              text: 'Transit and rides.',
              detail: 'Use public transit or ride‑hailing; check route availability in advance.',
            },
            {
              text: 'Parking options.',
              detail: 'Identify lots or street parking and payment methods.',
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: 'Student/senior discounts.',
              detail: 'Carry ID to access local concession pricing.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Check forecasts.',
              detail: 'Review updates on rain, heat, and wind; adjust plans accordingly.',
            },
            { text: 'Sun and rain gear.', detail: 'Pack sunscreen, hats, and compact umbrellas.' },
            {
              text: 'Heat and cold plans.',
              detail: 'Schedule indoor breaks or warm‑up stops when needed.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Day bag essentials.',
              detail: 'Carry maps, small first‑aid, and basic hygiene items.',
            },
            {
              text: 'Water and snacks.',
              detail: 'Stay hydrated; avoid overpriced tourist options.',
            },
            {
              text: 'Power banks.',
              detail: 'Charge phones and cameras for navigation and photos.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Stay aware.',
              detail: 'Keep belongings secure; avoid isolated areas after dark.',
            },
            {
              text: 'Group options.',
              detail: 'Join guided tours for added safety and local insight.',
            },
            {
              text: 'Emergency contacts.',
              detail: 'Save local assistance numbers and nearest clinic locations.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Respect rules.',
              detail: 'Follow signs and staff guidance on restricted areas.',
            },
            { text: 'Ask permission.', detail: 'Be courteous with portraits and private spaces.' },
            {
              text: 'Avoid blocking paths.',
              detail: 'Stay aware of traffic flow and other visitors.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Track small spends.',
              detail: 'Log snacks and souvenirs; small costs add up quickly.',
            },
            {
              text: 'Avoid tourist traps.',
              detail: 'Compare prices off main streets; ask locals for recommendations.',
            },
            {
              text: 'Use local deals.',
              detail: 'Seek resident rates, weekday discounts, and free days.',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Favorite spots.',
              detail: 'Note highlights to revisit or recommend to friends.',
            },
            {
              text: 'Improvements.',
              detail: 'Record friction points and better alternatives for next time.',
            },
            {
              text: 'Share tips.',
              detail: 'Post concise guidance to help others navigate efficiently.',
            },
          ],
        },
      ],
