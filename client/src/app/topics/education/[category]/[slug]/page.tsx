...
export default async function TopicsEducationResourceDetailPage({ params }: Props) {
  const { category, slug } = await params;
  const categoryData = educationHubData[category];
  const resource = categoryData?.resources.find((r) => r.slug === slug);
      ...
      <main className="min-h-screen pt-20 bg-slate-50">
        <section className="bg-slate-900 py-24 text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10 text-center">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight">{resource.name}</h1>
                    ...
                    <h3 className="text-2xl font-bold text-blue-900 mb-8 flex items-center gap-3">
                      ...
                      >
                        <path
                          ...
                          d="M12 18.75a6 6 0 006-6c0-3.313-2.687-6-6-6s-6 2.687-6 6 2.687 6 6 6zM12 15.75a3 3 0 100-6 3 3 0 000 6z"
                        />
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M12 2.25v1.5m0 16.5v1.5m7.5-9h-1.5m-15 0h-1.5m13.243-6.243l-1.06 1.06m-10.365 10.365l-1.06 1.06m10.365 0l1.06 1.06m-10.365-10.365l1.06-1.06"
                        />
                      </svg>
