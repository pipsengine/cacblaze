...
export const metadata: Metadata = {
  ...
  keywords: 'Nigeria freelancers, freelance developer, designer, writer, marketer, states',
};
...
const IMG4 =
  'https://images.pexels.com/photos/3184460/pexels-photo-3184460.jpeg?auto=compress&cs=tinysrgb&w=1200&q=80';
const IMG5 =
...
const FREELANCERS: Freelancer[] = [
  {
    ...
    highlights: ['React', 'TypeScript', 'UI'],
  },
  {
    id: 'abuja_writer',
    state: 'FCT Abuja',
    city: 'Abuja',
    name: 'Abuja Content Writer',
    image: IMG2,
    specialty: 'Content',
    availability: 'Flexible · Remote',
    highlights: ['Articles', 'SEO', 'Copy'],
  },
  {
    id: 'rivers_designer',
    state: 'Rivers',
    city: 'Port Harcourt',
    name: 'PH Brand Designer',
    image: IMG3,
    specialty: 'Design',
  ...
  },
  {
    ...
    state: 'Oyo',
    city: 'Ibadan',
    name: 'Ibadan Digital Marketer',
    image: IMG4,
    specialty: 'Marketing',
    availability: 'Flexible · Remote',
    highlights: ['Social', 'Ads', 'Content'],
  },
  {
    id: 'kano_mobile',
    state: 'Kano',
    city: 'Kano',
    name: 'Kano Mobile Dev',
    image: IMG1,
    specialty: 'Mobile',
    availability: 'Weekdays · 9:00 AM – 5:00 PM',
    highlights: ['Flutter', 'Firebase', 'UI'],
  },
  {
    id: 'kaduna_pm',
    state: 'Kaduna',
    city: 'Kaduna',
    name: 'Kaduna Project Manager',
    image: IMG5,
    specialty: 'PM',
    availability: 'Weekdays · 9:00 AM – 5:00 PM',
    highlights: ['Scrum', 'Roadmaps', 'Delivery'],
  },
  {
    id: 'enugu_seo',
    state: 'Enugu',
    city: 'Enugu',
    name: 'Enugu SEO Specialist',
    image: IMG2,
    specialty: 'SEO',
    availability: 'Flexible · Remote',
    highlights: ['On-page', 'Technical', 'Content'],
  },
  {
    id: 'anambra_analyst',
    state: 'Anambra',
    city: 'Awka',
    name: 'Awka Data Analyst',
    image: IMG1,
    specialty: 'Data',
    availability: 'Weekdays · 10:00 AM – 4:00 PM',
    highlights: ['Dashboards', 'SQL', 'Excel'],
  },
  {
    id: 'delta_smm',
    state: 'Delta',
    city: 'Asaba',
    name: 'Asaba Social Manager',
    image: IMG4,
    specialty: 'Social',
    availability: 'Flexible · Remote',
    highlights: ['Calendars', 'Assets', 'Engagement'],
  },
  {
    id: 'edo_copywriter',
    state: 'Edo',
    city: 'Benin City',
    name: 'Benin Copywriter',
    image: IMG2,
    specialty: 'Copy',
    availability: 'Weekdays · 9:00 AM – 4:00 PM',
    highlights: ['Web copy', 'Ads', 'Email'],
  },
  {
    id: 'ogun_graphics',
    state: 'Ogun',
    city: 'Abeokuta',
    name: 'Abeokuta Graphics',
    image: IMG3,
    specialty: 'Graphics',
    availability: 'Weekdays · 9:00 AM – 5:00 PM',
    highlights: ['Posters', 'Social', 'Brand'],
  },
  {
    id: 'osun_backend',
    state: 'Osun',
    city: 'Osogbo',
    name: 'Osogbo Backend Dev',
    image: IMG5,
    specialty: 'Backend',
    availability: 'Weekdays · 9:00 AM – 5:00 PM',
    highlights: ['Node', 'APIs', 'SQL'],
  },
  {
    id: 'kwara_uiux',
    state: 'Kwara',
    ...
    specialty: 'UI/UX',
    availability: 'Flexible · Remote',
    highlights: ['Wireframes', 'Prototypes', 'Testing'],
  },
  {
    id: 'plateau_editor',
    state: 'Plateau',
    city: 'Jos',
    name: 'Jos Video Editor',
    image: IMG1,
    specialty: 'Video',
    availability: 'Weekdays · 10:00 AM – 4:00 PM',
    highlights: ['Cuts', 'Effects', 'Sound'],
  },
  {
    id: 'imo_va',
    state: 'Imo',
    city: 'Owerri',
    name: 'Owerri Virtual Assistant',
    image: IMG4,
    specialty: 'Admin',
    availability: 'Flexible · Remote',
    highlights: ['Scheduling', 'Docs', 'Support'],
  },
];
