        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
            <section>
              ...
              <p>
                These Terms of Service ("Terms") constitute a legally binding agreement made between
                you, whether personally or on behalf of an entity ("you") and{' '}
                <strong>CACBLAZE</strong> ("we," "us," or "our"), concerning your access to and use
                of the CACBLAZE website and related services.
              </p>
              <p>
                By accessing or using the Service, you agree that you have read, understood, and
                agree to be bound by all of these Terms. If you do not agree with all of these
                Terms, then you are expressly prohibited from using the Service and you must
            ...
            <section>
              ...
              <p>
                The Service is intended for users who are at least 18 years old. Persons under the
                age of 18 are not permitted to use or register for the Service without direct
                parental supervision and consent.
              </p>
              <p>
                These Terms are governed by and construed in accordance with the{' '}
                <strong>laws of the Federal Republic of Nigeria</strong>. The Service is controlled
                and operated from our facilities in Nigeria. We make no representations that the
                Service is appropriate or available for use in other locations. Those who access or
                use the Service from other jurisdictions do so at their own volition and are
            ...
            <section>
              ...
              <p>
                You are responsible for safeguarding your password. You agree not to disclose your
                password to any third party and to take sole responsibility for any activities or
                actions under your account, whether or not you have authorized such activities. You
            ...
            <section>
              ...
              <p>
                ...
                make the Service available. As a user of the Service, you agree not to:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Violate any applicable Nigerian laws or regulations, including but not limited to
                  the <strong>Cybercrimes (Prohibition, Prevention, etc.) Act 2015</strong>.
                </li>
                <li>
                ...
                <li>
                  ...
                  providing any portion of the Service to you.
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                ...
                photographs, and graphics on the Service (collectively, the "Content") and the
                ...
                Nigeria, foreign jurisdictions, and international conventions.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                The Service may invite you to chat, contribute to, or participate in blogs, message
                ...
                distribute, or broadcast content and materials to us or on the Service, including
              ...
              <p>
                By posting your Contributions to any part of the Service, you automatically grant,
            ...
            <section>
              ...
              <p>
                ...
                use of the Service and our services will be at your sole risk. To the fullest extent
                permitted by law, we disclaim all warranties, express or implied, in connection with
                the Service and your use thereof, including, without limitation, the implied
                warranties of merchantability, fitness for a particular purpose, and
                non-infringement.
              </p>
              <p>
                We make no warranties or representations about the accuracy or completeness of the
                Service's content or the content of any websites linked to the Service and we will
                ...
                whatsoever, resulting from your access to and use of the Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                resolved by arbitration under the Arbitration and Conciliation Act (Cap. A18, Laws
                of the Federation of Nigeria 2004). The seat of the arbitration shall be{' '}
                <strong>Lagos, Nigeria</strong>. The language of the arbitration shall be English.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We reserve the right to change, modify, or remove the contents of the Service at any
                time or for any reason at our sole discretion without notice. However, we have no
                obligation to update any information on our Service. We also reserve the right to
                modify or discontinue all or part of the Service without notice at any time.
              </p>
            </section>
