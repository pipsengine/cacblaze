    ...
    return (
      <section className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <p className="text-red-500">
          Unable to load daily tips.{' '}
          {process.env.NODE_ENV !== 'development' && !API_BASE ? (
  ...
  return (
    <section className="bg-gradient-to-r from-green-50 to-emerald-50 py-12">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">💡 Daily Tips & Insights</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100 mb-6">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-3">{todaysTip.title}</h3>

          <p className="text-gray-700 leading-relaxed mb-4">{todaysTip.content}</p>
