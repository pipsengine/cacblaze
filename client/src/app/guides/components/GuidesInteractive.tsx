...
const GuidesInteractive = () => {
  ...
  const guides = [
  {
    ...
    excerpt: 'Learn the fundamentals and advanced techniques of building modern web applications with React, Next.js, and TypeScript.',
    category: 'Technology',
    readTime: '12 min',
    author: 'Sarah Chen',
    authorImage: "",
  ...
  },
  {
    ...
    excerpt: 'Proven techniques to boost your productivity and achieve your goals faster with practical time management systems.',
    category: 'Lifestyle',
    readTime: '8 min',
  ...
  },
  {
    ...
    excerpt: 'A beginner-friendly introduction to machine learning concepts and applications with hands-on examples.',
    category: 'Education',
    readTime: '15 min',
  ...
  },
  {
    ...
    excerpt: 'Transform your small space into a thriving garden with these expert tips for urban and apartment gardening.',
    category: 'Lifestyle',
    readTime: '10 min',
    author: 'James Park',
    authorImage: "",
  ...
  },
  {
    ...
    excerpt: 'Develop essential communication skills to lead teams effectively and inspire action.',
    category: 'Education',
    readTime: '11 min',
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-8">
            <p className="text-secondary">
              ...
              <span> in <span className="font-semibold text-foreground capitalize">{filters.category}</span></span>
              }
            </p>
          </div>
