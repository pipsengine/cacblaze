...
export default function PressPage() {
  ...
  const pressReleases = [
    { 
      ...
      summary: 'Milestone achievement highlights rapid growth in the digital education sector, driven by new personalized learning features and global expansion.'
    },
    { 
      date: 'Aug 02, 2025', 
      title: 'Launching the New Education Hub: A New Era for Online Learning', 
      source: 'CACBLAZE Blog',
      summary: 'Introducing a comprehensive suite of tools designed to empower self-directed learners and educators with AI-driven recommendations.'
    },
    { 
      date: 'May 10, 2025', 
      title: 'CACBLAZE Raises Series A to Expand Global Content Operations', 
      source: 'TechCrunch',
      summary: 'Investment led by Future Ventures will fuel content acquisition and platform development to serve emerging markets.'
    },
  ];
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-16">
                ...
                {/* Press Releases */}
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-8 pb-4 border-b border-gray-100">Latest News</h2>
                  <div className="space-y-10">
                    {pressReleases.map((item, idx) => (
                      <div key={idx} className="group cursor-pointer">
                        <div className="text-sm text-gray-500 mb-2 font-medium uppercase tracking-wider">{item.date} • {item.source}</div>
                ...
                {/* Company Boilerplate */}
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-100">About CACBLAZE</h2>
                  <div className="prose prose-lg text-gray-600">
                    <p>
                      CACBLAZE is a leading global digital knowledge platform dedicated to empowering individuals through accessible, high-quality education and information. Founded in 2023, the company has rapidly grown to serve over 2 million monthly active users across 150 countries.
                    </p>
                    <p className="mt-4">
                      Our mission is to democratize access to expert knowledge, bridging the gap between traditional education and the needs of the modern workforce. Through our proprietary AI-driven recommendation engine, we connect learners with the resources they need to succeed in their careers and personal lives.
                    </p>
                  </div>
                </div>
                ...
                {/* Spokespeople */}
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-8 pb-4 border-b border-gray-100">Spokespeople</h2>
              ...
              <div className="lg:col-span-1">
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100">
                  ...
                  <p className="text-gray-600 mb-6 text-sm">
                    For press inquiries, interviews, or speaking requests, please contact our communications team.
                  </p>
                  <a href="mailto:press@cacblaze.com" className="block w-full py-3 bg-white border border-gray-200 text-gray-900 font-semibold rounded-lg text-center hover:border-indigo-600 hover:text-indigo-600 transition-colors mb-8">
                    press@cacblaze.com
                  </a>
                  ...
                  <div className="space-y-3">
                    <button className="flex items-center justify-between w-full p-3 bg-white rounded-lg border border-gray-200 hover:border-indigo-300 transition-colors">
                      <span className="text-sm font-medium text-gray-700">Logo Pack (SVG, PNG)</span>
