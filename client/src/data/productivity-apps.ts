...
export const productivityAppReviews: Record<string, ProductivityAppReview> = {
  'notion-review': {
    ...
    rating: 4.8,
    description:
      'The definitive all-in-one workspace for notes, docs, wikis, and project management. Highly popular among Nigerian startups.',
    author: {
  ...
  'trello-review': {
    ...
    rating: 4.5,
    description:
      'A visual way for teams to manage any project using boards, lists, and cards. Extremely intuitive for beginners.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
    ...
    heroImage:
      'https://images.unsplash.com/photo-1522071823991-b5ae72647a4a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
  ...
  'evernote-review': {
    ...
    rating: 4.0,
    description:
      'The veteran of note-taking apps. Excellent for capturing web snippets and organizing large archives of documents.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'slack-review': {
    ...
    rating: 4.7,
    description:
      'The hub of remote work communication. Replaces internal emails with organized channels and instant messaging.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'forest-review': {
    ...
    rating: 4.9,
    description:
      'Stay focused by planting a virtual tree. If you leave the app to check social media, your tree withers. A great focus tool for students.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'todoist-review': {
    ...
    rating: 4.6,
    description:
      'A clean, distraction-free task manager that uses natural language processing to make adding tasks easy.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'calendly-review': {
    ...
    rating: 4.4,
    description:
      'Eliminates the "when are you free?" email dance. Perfect for Nigerian entrepreneurs and freelancers.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'obsidian-review': {
    ...
    rating: 4.8,
    description:
      'A powerful knowledge base that works on top of a local folder of plain text Markdown files. The choice for power users.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
    ...
    cons: [
      ...
      'Syncing requires extra work/payment',
      'Mobile app setup can be tricky',
    ],
  ...
  'canva-review': {
    ...
    rating: 4.9,
    description:
      'Not just for designers. Canva is a productivity beast for creating presentations, social posts, and documents in minutes.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'pocket-review': {
    ...
    rating: 4.3,
    description:
      'Save articles, videos, and stories from any publication or page. Perfect for commuting or reading during NEPA blackouts.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
