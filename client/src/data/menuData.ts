    ...
    },
    {
      ...
      categories: [
        // ALL EDUCATION CATEGORIES GROUPED TOGETHER
        {
          ...
          items: [
            { id: 'education_study', label: 'Study Techniques', href: '/topics/education/study-techniques' },
            { id: 'education_exam', label: 'Exam Preparation', href: '/topics/education/exam-prep' },
            { id: 'education_guides', label: 'Study Guides', href: '/topics/education/study-guides' },
            { id: 'education_admissions', label: 'University Admissions', href: '/topics/education/admissions' },
            { id: 'education_scholarships', label: 'Scholarships', href: '/topics/education/scholarships' },
          ],
          group: 'Education',
        },
        {
          ...
          items: [
            { id: 'education_english', label: 'Learn English', href: '/topics/education/learn-english' },
            { id: 'education_french', label: 'Learn French', href: '/topics/education/learn-french' },
            { id: 'education_local_lang', label: 'Local Languages', href: '/topics/education/local-languages' },
          ],
          group: 'Education',
        },
        {
          ...
          items: [
            { id: 'education_coding', label: 'Learn Coding', href: '/topics/education/learn-coding' },
            { id: 'education_design', label: 'Graphic Design', href: '/topics/education/graphic-design' },
            { id: 'education_marketing', label: 'Digital Marketing', href: '/topics/education/digital-marketing' },
            { id: 'education_certifications', label: 'Certifications', href: '/topics/education/certifications' },
            { id: 'education_career', label: 'Career Advice', href: '/topics/education/career-advice' },
            { id: 'education_digital_education', label: 'Digital Education', href: '/topics/education/digital-education' },
            { id: 'education_online_courses', label: 'Online Courses', href: '/topics/education/online-courses' },
          ],
          group: 'Education',
        },
        {
          ...
          items: [
            { id: 'education_productivity', label: 'Productivity', href: '/topics/education/student-productivity' },
            { id: 'education_mental_health', label: 'Mental Health', href: '/topics/education/mental-health' },
            { id: 'education_budgeting', label: 'Student Budgeting', href: '/topics/education/student-budgeting' },
          ],
          group: 'Education',
        },
        ...
        // ALL TECHNOLOGY CATEGORIES GROUPED TOGETHER
        {
          ...
          items: [
            { id: 'tech_internet_issues', label: 'Internet & Data Issues', href: '/topics/technology/internet-issues' },
            { id: 'tech_no_service', label: 'No Service on Phone', href: '/topics/technology/no-service' },
            { id: 'tech_data_plan', label: 'Best Data Plans', href: '/topics/technology/data-plans' },
            { id: 'tech_smartphones', label: 'Smartphone Problems', href: '/topics/technology/smartphone-problems' },
            { id: 'tech_overheating', label: 'Phone Overheating', href: '/topics/technology/phone-overheating' },
            { id: 'tech_battery', label: 'Battery Draining Fast', href: '/topics/technology/battery-draining' },
            { id: 'tech_storage', label: 'Storage Full Solutions', href: '/topics/technology/storage-full' },
            { id: 'tech_router', label: 'Router Setup & Wi-Fi', href: '/topics/technology/router-setup' },
            { id: 'tech_cloud', label: 'Cloud & Backup Issues', href: '/topics/technology/cloud-storage' },
            { id: 'tech_troubleshoot', label: 'Error Codes & Logins', href: '/topics/technology/error-codes' },
          ],
          group: 'Technology',
        },
        {
          ...
          items: [
            { id: 'tech_whatsapp_hacked', label: 'WhatsApp Hacked', href: '/topics/technology/whatsapp-hacked' },
            { id: 'tech_account_banned', label: 'Account Banned', href: '/topics/technology/account-banned' },
            { id: 'tech_fb_locked', label: 'Facebook Locked', href: '/topics/technology/facebook-locked' },
            { id: 'tech_scams', label: 'Scams & Fraud', href: '/topics/technology/scams-fraud' },
            { id: 'tech_pos_fraud', label: 'POS Fraud Safety', href: '/topics/technology/pos-fraud' },
            { id: 'tech_debit_alert', label: 'Unknown Debit Alerts', href: '/topics/technology/unknown-debit' },
            { id: 'tech_privacy', label: 'Data Privacy & Security', href: '/topics/technology/data-privacy' },
            { id: 'tech_hacked', label: 'Account Hacked Help', href: '/topics/technology/account-hacked' },
            { id: 'tech_verification', label: 'Is This Legit?', href: '/topics/technology/verification' },
            { id: 'tech_legal', label: 'Legal & Tech Rights', href: '/topics/technology/tech-rights' },
          ],
          group: 'Technology',
        },
        {
          ...
          items: [
            { id: 'tech_payments', label: 'Digital Payments', href: '/topics/technology/digital-payments' },
            { id: 'tech_transfer_issues', label: 'Transfer Pending/Reversal', href: '/topics/technology/transfer-issues' },
            { id: 'tech_pos_ops', label: 'POS Operations', href: '/topics/technology/pos-operations' },
            { id: 'tech_govt', label: 'NIN, BVN & Govt IDs', href: '/topics/technology/govt-ids' },
            { id: 'tech_passport', label: 'Passport & Driver License', href: '/topics/technology/passport-license' },
            { id: 'tech_small_biz', label: 'Small Business Tech', href: '/topics/technology/small-business' },
            { id: 'tech_remote_work', label: 'Remote Work & Income', href: '/topics/technology/remote-work' },
            { id: 'tech_freelancing', label: 'Freelancing Platforms', href: '/topics/technology/freelancing' },
            { id: 'tech_dollar_pay', label: 'Dollar Earnings', href: '/topics/technology/dollar-earnings' },
            { id: 'tech_jobs', label: 'Job Search & Careers', href: '/topics/technology/careers' },
          ],
          group: 'Technology',
        },
        {
          ...
          items: [
            { id: 'tech_software', label: 'Software How-Tos', href: '/topics/technology/software-howto' },
            { id: 'tech_excel', label: 'Excel & Office Tips', href: '/topics/technology/excel-tips' },
            { id: 'tech_ai', label: 'AI Tools & Assistants', href: '/topics/technology/ai-tools' },
            { id: 'tech_chatgpt', label: 'ChatGPT Alternatives', href: '/topics/technology/chatgpt-alternatives' },
            { id: 'tech_education', label: 'Digital Education', href: '/topics/technology/digital-education' },
            { id: 'tech_courses', label: 'Online Courses', href: '/topics/technology/online-courses' },
            { id: 'tech_buying', label: 'Buying Guides', href: '/topics/technology/buying-guides' },
            { id: 'tech_best_phones', label: 'Best Phones Under ₦X', href: '/topics/technology/best-phones' },
            { id: 'tech_laptops', label: 'Student Laptops', href: '/topics/technology/student-laptops' },
            { id: 'tech_templates', label: 'Templates & Checklists', href: '/topics/technology/templates' },
          ],
          group: 'Technology',
        },
        ...
        // ALL LIFESTYLE CATEGORIES GROUPED TOGETHER
        {
          ...
          items: [
            { id: 'lifestyle_healthy_living', label: 'Healthy Living Tips', href: '/topics/lifestyle/healthy-living' },
            { id: 'lifestyle_nutrition', label: 'Nutrition Education', href: '/topics/lifestyle/nutrition' },
            { id: 'lifestyle_fitness', label: 'Fitness Guides', href: '/topics/lifestyle/fitness' },
            { id: 'lifestyle_mental', label: 'Mental Wellness', href: '/topics/lifestyle/mental-wellness' },
            { id: 'lifestyle_stress', label: 'Stress Management', href: '/topics/lifestyle/stress-management' },
            { id: 'lifestyle_sleep', label: 'Sleep Improvement', href: '/topics/lifestyle/sleep' },
            { id: 'lifestyle_hygiene', label: 'Personal Hygiene', href: '/topics/lifestyle/hygiene' },
            { id: 'lifestyle_habits', label: 'Lifestyle Habits', href: '/topics/lifestyle/habits' },
            { id: 'lifestyle_home_wellness', label: 'Home Wellness Routines', href: '/topics/lifestyle/home-wellness' },
          ],
          group: 'Lifestyle',
        },
        {
          ...
          items: [
            { id: 'lifestyle_pregnancy', label: 'Pregnancy Education', href: '/topics/lifestyle/pregnancy' },
            { id: 'lifestyle_newborn', label: 'Newborn Care', href: '/topics/lifestyle/newborn-care' },
            { id: 'lifestyle_child_dev', label: 'Child Development', href: '/topics/lifestyle/child-development' },
            { id: 'lifestyle_parenting_tips', label: 'Parenting Tips', href: '/topics/lifestyle/parenting-tips' },
            { id: 'lifestyle_education_support', label: 'Education Support', href: '/topics/lifestyle/education-support' },
            { id: 'lifestyle_family_budget', label: 'Family Budgeting', href: '/topics/lifestyle/family-budgeting' },
            { id: 'lifestyle_home_routines', label: 'Home Routines', href: '/topics/lifestyle/home-routines' },
            { id: 'lifestyle_parenting_resources', label: 'Parenting Resources', href: '/topics/lifestyle/parenting-resources' },
          ],
          group: 'Lifestyle',
        },
        {
          ...
          items: [
            { id: 'lifestyle_travel_planning', label: 'Travel Planning', href: '/topics/lifestyle/travel-planning' },
            { id: 'lifestyle_budget_travel', label: 'Budget Travel', href: '/topics/lifestyle/budget-travel' },
            { id: 'lifestyle_travel_safety', label: 'Travel Safety', href: '/topics/lifestyle/travel-safety' },
            { id: 'lifestyle_accommodation', label: 'Accommodation Guides', href: '/topics/lifestyle/accommodation' },
            { id: 'lifestyle_transportation', label: 'Transportation Tips', href: '/topics/lifestyle/transportation' },
            { id: 'lifestyle_living_abroad', label: 'Living Abroad Guides', href: '/topics/lifestyle/living-abroad' },
            { id: 'lifestyle_cultural', label: 'Cultural Tips', href: '/topics/lifestyle/cultural-tips' },
            { id: 'lifestyle_culture_main', label: 'Nigerian Culture', href: '/topics/lifestyle/nigerian-culture' },
            { id: 'lifestyle_local_tourism', label: 'Local Tourism', href: '/topics/lifestyle/local-tourism' },
          ],
          group: 'Lifestyle',
        },
      ],
