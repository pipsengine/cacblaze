  ...
  mainMenu: [
      ...
      categories: [
        ...
        },
        {
          ...
          items: [
            ...
            { id: 'guides_job_market', label: 'Job Market', href: '/job-market' },
        ...
        },
        {
          ...
          items: [
            ...
            { id: 'howto_office_tools', label: 'Use Office Tools', href: '/howto/office-tools' },
            {
              ...
              label: 'Create Digital Content',
              href: '/howto/digital-content',
            },
      ...
      categories: [
        {
          ...
          items: [
            ...
            { id: 'education_exam', label: 'Exam Preparation', href: '/education/exam-prep' },
            { id: 'education_guides', label: 'Study Guides', href: '/education/study-guides' },
            {
        ...
        },
        {
          ...
          items: [
            { id: 'education_english', label: 'Learn English', href: '/education/learn-english' },
            { id: 'education_french', label: 'Learn French', href: '/education/learn-french' },
            {
              id: 'education_local_lang',
        ...
        },
        {
          ...
          items: [
            { id: 'education_coding', label: 'Learn Coding', href: '/education/learn-coding' },
            { id: 'education_design', label: 'Graphic Design', href: '/education/graphic-design' },
            {
              id: 'education_marketing',
            ...
            { id: 'education_career', label: 'Career Advice', href: '/education/career-advice' },
          ],
        },
        {
          ...
          items: [
            ...
            {
              id: 'education_mental_health',
              label: 'Mental Health',
              href: '/education/mental-health',
            },
            {
              id: 'education_budgeting',
      ...
      categories: [
        {
          ...
          items: [
            ...
            { id: 'tech_no_service', label: 'No Service on Phone', href: '/technology/no-service' },
            { id: 'tech_data_plan', label: 'Best Data Plans', href: '/technology/data-plans' },
            {
              id: 'tech_smartphones',
            ...
            { id: 'tech_router', label: 'Router Setup & Wi-Fi', href: '/technology/router-setup' },
            { id: 'tech_cloud', label: 'Cloud & Backup Issues', href: '/technology/cloud-storage' },
            {
        ...
        },
        {
          ...
          items: [
            ...
            { id: 'tech_fb_locked', label: 'Facebook Locked', href: '/technology/facebook-locked' },
            { id: 'tech_scams', label: 'Scams & Fraud', href: '/technology/scams-fraud' },
            { id: 'tech_pos_fraud', label: 'POS Fraud Safety', href: '/technology/pos-fraud' },
            {
              id: 'tech_debit_alert',
            ...
            { id: 'tech_hacked', label: 'Account Hacked Help', href: '/technology/account-hacked' },
            { id: 'tech_verification', label: 'Is This Legit?', href: '/technology/verification' },
            { id: 'tech_legal', label: 'Legal & Tech Rights', href: '/technology/tech-rights' },
          ],
        },
        {
          id: 'tech_col3',
          label: 'Finance, Govt & Business',
          items: [
            {
              id: 'tech_payments',
            ...
            { id: 'tech_pos_ops', label: 'POS Operations', href: '/technology/pos-operations' },
            { id: 'tech_govt', label: 'NIN, BVN & Govt IDs', href: '/technology/govt-ids' },
            {
              id: 'tech_passport',
            ...
            { id: 'tech_jobs', label: 'Job Search & Careers', href: '/technology/careers' },
          ],
        },
        {
          id: 'tech_col4',
          label: 'Tools, Learning & Buying',
          items: [
            { id: 'tech_software', label: 'Software How-Tos', href: '/technology/software-howto' },
            { id: 'tech_excel', label: 'Excel & Office Tips', href: '/technology/excel-tips' },
            { id: 'tech_ai', label: 'AI Tools & Assistants', href: '/technology/ai-tools' },
            {
              id: 'tech_chatgpt',
            ...
            { id: 'tech_courses', label: 'Online Courses', href: '/technology/online-courses' },
            { id: 'tech_buying', label: 'Buying Guides', href: '/technology/buying-guides' },
            {
              id: 'tech_best_phones',
              label: 'Best Phones Under ₦X',
              href: '/technology/best-phones',
            },
            { id: 'tech_laptops', label: 'Student Laptops', href: '/technology/student-laptops' },
            {
              id: 'tech_templates',
    ...
    },
    {
      ...
      categories: [
        {
          id: 'lifestyle_health',
          label: 'Health, Wellness & Lifestyle',
          items: [
            {
              id: 'lifestyle_healthy_living',
              label: 'Healthy Living Tips',
              href: '/lifestyle/healthy-living',
            },
            {
              id: 'lifestyle_nutrition',
              label: 'Nutrition Education',
              href: '/lifestyle/nutrition',
            },
            { id: 'lifestyle_fitness', label: 'Fitness Guides', href: '/lifestyle/fitness' },
            {
              id: 'lifestyle_mental',
              label: 'Mental Wellness',
              href: '/lifestyle/mental-wellness',
            },
            {
              id: 'lifestyle_stress',
              label: 'Stress Management',
              href: '/lifestyle/stress-management',
            },
            { id: 'lifestyle_sleep', label: 'Sleep Improvement', href: '/lifestyle/sleep' },
            { id: 'lifestyle_hygiene', label: 'Personal Hygiene', href: '/lifestyle/hygiene' },
            { id: 'lifestyle_habits', label: 'Lifestyle Habits', href: '/lifestyle/habits' },
            {
              id: 'lifestyle_home_wellness',
              label: 'Home Wellness Routines',
              href: '/lifestyle/home-wellness',
            },
          ],
        },
        {
          id: 'lifestyle_parenting',
          label: 'Parenting & Family',
          items: [
            {
              id: 'lifestyle_pregnancy',
              label: 'Pregnancy Education',
              href: '/lifestyle/pregnancy',
            },
            { id: 'lifestyle_newborn', label: 'Newborn Care', href: '/lifestyle/newborn-care' },
            {
              id: 'lifestyle_child_dev',
              label: 'Child Development',
              href: '/lifestyle/child-development',
            },
            {
              id: 'lifestyle_parenting_tips',
              label: 'Parenting Tips',
              href: '/lifestyle/parenting-tips',
            },
            {
              id: 'lifestyle_education_support',
              label: 'Education Support',
              href: '/lifestyle/education-support',
            },
            {
              id: 'lifestyle_family_budget',
              label: 'Family Budgeting',
              href: '/lifestyle/family-budgeting',
            },
            {
              id: 'lifestyle_home_routines',
              label: 'Home Routines',
              href: '/lifestyle/home-routines',
            },
            {
              id: 'lifestyle_parenting_resources',
              label: 'Parenting Resources',
              href: '/lifestyle/parenting-resources',
            },
          ],
        },
        {
          ...
          items: [
            {
              id: 'lifestyle_travel_planning',
              label: 'Travel Planning',
              href: '/lifestyle/travel-planning',
            },
            {
              id: 'lifestyle_budget_travel',
              label: 'Budget Travel',
              href: '/lifestyle/budget-travel',
            },
            {
              id: 'lifestyle_travel_safety',
              label: 'Travel Safety',
              href: '/lifestyle/travel-safety',
            },
            {
              id: 'lifestyle_accommodation',
              label: 'Accommodation Guides',
              href: '/lifestyle/accommodation',
            },
            {
              id: 'lifestyle_transportation',
              label: 'Transportation Tips',
              href: '/lifestyle/transportation',
            },
            {
              id: 'lifestyle_living_abroad',
              label: 'Living Abroad Guides',
              href: '/lifestyle/living-abroad',
            },
            { id: 'lifestyle_cultural', label: 'Cultural Tips', href: '/lifestyle/cultural-tips' },
            {
              id: 'lifestyle_culture_main',
              label: 'Nigerian Culture',
              href: '/lifestyle/nigerian-culture',
            },
            {
              id: 'lifestyle_local_tourism',
              label: 'Local Tourism',
              href: '/lifestyle/local-tourism',
            },
          ],
        },
      ],
      ...
      categories: [
        ...
        },
        {
          ...
          items: [
            ...
            { id: 'local_city_guides', label: 'City Guides', href: '/nigerian-cities' },
      ...
      categories: [
        {
          ...
          items: [
            ...
            { id: 'community_ama', label: 'AMA Sessions', href: '/ama' },
          ],
        },
      ],
    },
