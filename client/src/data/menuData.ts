      ...
      categories: [
        {
          ...
          items: [
            { id: 'tech_internet_issues', label: 'Internet & Data Issues', href: '/technology/internet-issues' },
            ...
            { id: 'tech_smartphones', label: 'Smartphone Problems', href: '/technology/smartphone-problems' },
            { id: 'tech_overheating', label: 'Phone Overheating', href: '/technology/phone-overheating' },
            { id: 'tech_battery', label: 'Battery Draining Fast', href: '/technology/battery-draining' },
            { id: 'tech_storage', label: 'Storage Full Solutions', href: '/technology/storage-full' },
            ...
            { id: 'tech_troubleshoot', label: 'Error Codes & Logins', href: '/technology/error-codes' },
          ],
        },
        {
          id: 'tech_safety',
          ...
          items: [
            { id: 'tech_whatsapp_hacked', label: 'WhatsApp Hacked', href: '/technology/whatsapp-hacked' },
            { id: 'tech_account_banned', label: 'Account Banned', href: '/technology/account-banned' },
            ...
            { id: 'tech_debit_alert', label: 'Unknown Debit Alerts', href: '/technology/unknown-debit' },
            { id: 'tech_privacy', label: 'Data Privacy & Security', href: '/technology/data-privacy' },
        ...
        },
        {
          ...
          items: [
            { id: 'tech_payments', label: 'Digital Payments', href: '/technology/digital-payments' },
            { id: 'tech_transfer_issues', label: 'Transfer Pending/Reversal', href: '/technology/transfer-issues' },
            ...
            { id: 'tech_passport', label: 'Passport & Driver License', href: '/technology/passport-license' },
            { id: 'tech_small_biz', label: 'Small Business Tech', href: '/technology/small-business' },
            { id: 'tech_remote_work', label: 'Remote Work & Income', href: '/technology/remote-work' },
            { id: 'tech_freelancing', label: 'Freelancing Platforms', href: '/technology/freelancing' },
            { id: 'tech_dollar_pay', label: 'Dollar Earnings', href: '/technology/dollar-earnings' },
        ...
        },
        {
          ...
          items: [
            ...
            { id: 'tech_chatgpt', label: 'ChatGPT Alternatives', href: '/technology/chatgpt-alternatives' },
            { id: 'tech_education', label: 'Digital Education', href: '/technology/digital-education' },
            ...
            { id: 'tech_best_phones', label: 'Best Phones Under ₦X', href: '/technology/best-phones' },
            { id: 'tech_laptops', label: 'Student Laptops', href: '/technology/student-laptops' },
            { id: 'tech_templates', label: 'Templates & Checklists', href: '/technology/templates' },
          ],
        },
      ],
    },
    {
      ...
      categories: [
        ...
        },
        {
          ...
          items: [
            { id: 'lifestyle_accommodation', label: 'Accommodation Guides', href: '/lifestyle/accommodation-guides' },
            { id: 'lifestyle_budget_travel', label: 'Budget Travel', href: '/lifestyle/budget-travel' },
            { id: 'lifestyle_travel_safety', label: 'Travel Safety', href: '/lifestyle/travel-safety' },
            { id: 'lifestyle_transportation', label: 'Transportation Tips', href: '/lifestyle/transportation' },
            { id: 'lifestyle_living_abroad', label: 'Living Abroad Guides', href: '/lifestyle/living-abroad' },
            { id: 'lifestyle_cultural', label: 'Cultural Tips', href: '/lifestyle/cultural-tips' },
            { id: 'lifestyle_culture_main', label: 'Nigerian Culture', href: '/lifestyle/nigerian-culture' },
            { id: 'lifestyle_local_tourism', label: 'Local Tourism', href: '/lifestyle/local-tourism' },
          ],
          group: 'Lifestyle',
        },
      ],
