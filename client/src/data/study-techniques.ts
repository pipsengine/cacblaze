...
export const studyTechniques: Record<string, StudyTechnique> = {
  'pomodoro-technique': {
    ...
    steps: [
      ...
      { title: 'Set a Timer', content: 'Set your timer for 25 minutes.' },
      {
        ...
        content: 'Focus solely on the task until the timer goes off.',
      },
      { title: 'Take a Short Break', content: 'Take a 5-minute break to stretch or grab water.' },
      {
        title: 'Repeat & Long Break',
        content: 'After 4 Pomodoros, take a longer 15-30 minute break.',
      },
    ],
    author: {
  ...
  'active-recall': {
    ...
    steps: [
      ...
      {
        title: 'Check & Repeat',
        content: 'Open the book to see what you missed and repeat the process.',
      },
    ],
    author: {
      name: 'Dr. Mark Sloan',
  ...
  'blurting-method': {
    ...
    rating: 4.6,
    description:
      'A popular revision technique that involves "blurting" out everything you know about a topic on paper.',
    heroImage:
    ...
    steps: [
      ...
      {
        title: 'The Blurt',
        content: 'Set a timer and write everything you remember without looking at notes.',
      },
      {
        title: 'Gap Analysis',
        content: 'Use a different color pen to add missing information from your textbook.',
      },
  ...
  'sq3r-method': {
    ...
    steps: [
      ...
      {
        title: 'Read',
        content: 'Read the section actively looking for answers to your questions.',
      },
  ...
  'leitner-system': {
    ...
    rating: 4.8,
    description:
      'An efficient way of using flashcards with spaced repetition using multiple boxes.',
    heroImage:
      'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    benefits: [
    ...
    steps: [
      ...
      {
        title: 'Promotion',
        content: 'Correctly answered cards move to Box 2 (reviewed every 2 days).',
      },
  ...
  'mind-mapping': {
    ...
    rating: 4.7,
    description:
      'A visual way to organize information into a hierarchy, showing relationships among pieces of the whole.',
    heroImage:
      'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    benefits: [
      'Visual organization',
    ...
    steps: [
      {
        title: 'Central Idea',
        content: 'Start in the center of a blank page with the main topic.',
      },
      ...
      {
        title: 'Color & Images',
        content: 'Use colors and simple drawings to make it more memorable.',
      },
    ],
    author: {
      name: 'Tony Buzan',
  ...
  'cornell-note-taking': {
    ...
    rating: 4.6,
    description:
      'A systematic format for condensing and organizing notes without laborious recopying.',
    heroImage:
      'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    benefits: [
    ...
    steps: [
      {
        title: 'Page Setup',
        content: 'Divide your page into three sections: Cue, Note, and Summary.',
      },
  ...
  'eat-the-frog': {
    ...
    rating: 4.4,
    description:
      'A productivity method that encourages you to tackle your hardest task first thing in the morning.',
    heroImage:
      'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    benefits: [
    ...
    steps: [
      {
        title: 'Identify the Frog',
        content: 'Choose the one task you are most likely to procrastinate on.',
      },
      {
        title: 'Do it First',
        content: 'Start this task before anything else in your study session.',
      },
      {
        title: 'No Distractions',
        content: 'Do not check emails or phones until the frog is eaten.',
      },
      {
        title: 'Reward Yourself',
        content: 'Move on to easier tasks with a sense of accomplishment.',
      },
    ],
    author: {
      name: 'Brian Tracy',
    ...
    steps: [
      {
        ...
        content: 'Write the name of the concept at the top of a blank sheet of paper.',
      },
      {
      ...
      {
        title: 'Simplify Further',
        content: 'Use analogies and clear language to further simplify your explanation.',
      },
    ],
    author: {
    ...
    steps: [
      {
        ...
        content: 'Break information into small, testable chunks on flashcards.',
      },
      { title: 'Initial Review', content: 'Review your new cards for the first time.' },
      {
        title: 'Graduated Intervals',
        content: 'Review successful cards after 1 day, then 3 days, 1 week, etc.',
      },
      {
        title: 'Reset on Failure',
        content: 'If you forget a card, move it back to the daily review pile.',
      },
    ],
    author: {
      name: 'Dr. Emily Carter',
