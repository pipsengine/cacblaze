...
export const tabletReviews: Record<string, TabletReview> = {
  'ipad-pro-m4': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
  ...
  'galaxy-tab-s9-ultra': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1634045540919-45917812580a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
