...
export const businessToolReviews: Record<string, BusinessToolReview> = {
  'slack-review': {
    ...
    rating: 4.8,
    description:
      'The industry standard for team communication. Slack replaces internal email with channels, making collaboration faster and more organized.',
    author: {
  ...
  'zoom-review': {
    ...
    rating: 4.7,
    description:
      'Reliable video conferencing that works even on low-bandwidth connections, making it a favorite for remote teams in Nigeria.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'salesforce-review': {
    ...
    rating: 4.6,
    description:
      "The world's #1 CRM platform. Salesforce provides a comprehensive suite of tools for sales, service, marketing, and more.",
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'quickbooks-review': {
    ...
    rating: 4.5,
    description:
      'Comprehensive accounting software for small businesses. It handles invoicing, expenses, and tax preparation with ease.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'canva-pro-review': {
    ...
    rating: 4.9,
    description:
      'Empowers non-designers to create professional-quality graphics, presentations, and social media content.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
    ...
    verdict:
      'The best tool for businesses that need high-quality design without a professional designer.',
  },
  'google-workspace-review': {
    ...
    rating: 4.8,
    description:
      'The definitive suite of cloud-based productivity tools, including Gmail, Drive, Docs, Sheets, and Slides.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
    ...
    cons: [
      'Offline mode can be finicky',
      'Sheets is less powerful than Excel',
  ...
  'mailchimp-review': {
    ...
    rating: 4.4,
    description:
      'The leading email marketing platform that helps businesses reach their audience through automated campaigns and newsletters.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
  ...
  'asana-review': {
    ...
    rating: 4.6,
    description:
      'A powerful project management tool that helps teams track work, from daily tasks to strategic initiatives.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
    ...
    cons: [
      'Can be overwhelming',
      'Steep price for premium features',
  ...
  'shopify-review': {
    ...
    rating: 4.7,
    description:
      'The all-in-one commerce platform that lets anyone start, grow, and manage a business online and in-person.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
    ...
    heroImage:
      'https://images.unsplash.com/photo-1556742044-3c52d6e88c62?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
    ...
    cons: [
      ...
      'Liquid templating can be complex',
    ],
  ...
  'linkedin-sales-navigator-review': {
    ...
    rating: 4.3,
    description:
      "Advanced search and filtering for sales professionals looking to find and connect with leads on the world's largest professional network.",
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image:
    ...
    pros: [
      'Unparalleled database of professionals',
