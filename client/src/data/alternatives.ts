...
export const alternatives: Record<string, AlternativeReview> = {
  'linear-vs-jira': {
    ...
    rating: 4.9,
    description:
      'Linear is the high-performance alternative to Jira, designed specifically for software teams who want speed, keyboard shortcuts, and a streamlined workflow.',
    author: {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1611224885990-ab7363d1f2a9?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyDifferences: [
    ...
    cons: [
      ...
      'Focused strictly on software dev',
    ],
    verdict:
      'If you find Jira slow and overwhelming, Linear is the breath of fresh air your engineering team needs.',
  },
  'framer-vs-webflow': {
    id: 'alt_2',
    ...
    rating: 4.8,
    description:
      'Framer has evolved from a prototyping tool into a powerful Webflow alternative that allows designers to ship high-end sites directly from a canvas.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image:
    ...
    bestFor:
      'Designers who want to build high-converting landing pages and portfolios without learning CSS.',
    pricingComparison: {
    ...
    verdict:
      'For landing pages and marketing sites, Framer is faster and more intuitive than Webflow.',
  },
  'ghost-vs-wordpress': {
    id: 'alt_3',
    ...
    rating: 4.7,
    description:
      'Ghost is the modern, non-profit alternative to WordPress, focusing entirely on professional publishing and newsletter subscriptions.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image:
    ...
    cons: [
      'Harder to self-host for beginners',
      'Limited for non-blog sites',
      'Fewer themes than WP',
    ],
    verdict:
      'Ghost is the clear winner for writers who want a fast, focused platform without the maintenance headache of WordPress.',
  },
  'obsidian-vs-notion': {
    id: 'alt_4',
    ...
    rating: 4.6,
    description:
      'Obsidian is the local-first, privacy-focused alternative to Notion, using Markdown files stored on your own device.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image:
    ...
    cons: [
      ...
      'No native database tables like Notion',
    ],
    verdict:
      'If you care about data privacy and want a tool that grows with your thoughts, Obsidian is unbeatable.',
  },
  'brave-vs-chrome': {
    id: 'alt_5',
    ...
    rating: 4.5,
    description:
      'Brave is the privacy-centric alternative to Chrome that blocks ads and trackers out of the box while staying compatible with all Chrome extensions.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image:
    ...
    cons: [
      'Crypto features can feel cluttered',
      'Some sites might break (rare)',
      'Sync is less seamless than Google',
    ],
    verdict:
      'Brave offers the same speed as Chrome but with the privacy protections you actually want.',
  },
  'bitwarden-vs-lastpass': {
    ...
    rating: 4.9,
    description:
      'Bitwarden is the open-source alternative to LastPass, offering more features for free and better transparency for security-conscious users.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image:
    ...
    cons: [
      ...
      'Premium features are advanced',
      'None worth mentioning',
    ],
    verdict:
      'After LastPass restricted their free plan, Bitwarden became the obvious choice for both individuals and families.',
  },
  'affinity-photo-vs-photoshop': {
    ...
    rating: 4.7,
    description:
      'Affinity Photo is the professional alternative to Photoshop that you can own for a one-time payment, ending the subscription nightmare.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image:
    ...
    verdict:
      'Affinity Photo is a powerful, professional-grade tool that pays for itself in just 4 months of not paying Adobe.',
  },
  'da-vinci-resolve-vs-premiere-pro': {
    ...
    rating: 4.8,
    description:
      'DaVinci Resolve is the Hollywood-standard alternative to Premiere Pro, offering world-class color grading and a robust free version.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image:
    ...
    cons: [
      ...
      'Fusion has a steep learning curve',
      'Collaboration requires a database',
    ],
    verdict:
      'For most creators, the free version of DaVinci Resolve is more powerful than the paid version of Premiere Pro.',
  },
  'signal-vs-whatsapp': {
    id: 'alt_9',
    ...
    rating: 4.6,
    description:
      'Signal is the ultimate privacy alternative to WhatsApp, run by a non-profit foundation with zero data harvesting.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image:
    ...
    heroImage:
      'https://images.unsplash.com/photo-1611746872915-64382b5c76da?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyDifferences: [
    ...
    cons: [
      ...
      'Missing some social features',
      'Desktop app requires phone sync',
    ],
  ...
  'proton-mail-vs-gmail': {
    ...
    rating: 4.7,
    description:
      'Proton Mail is the secure, encrypted alternative to Gmail, based in Switzerland and protected by strict privacy laws.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image:
    ...
    cons: [
      'Free storage is small (1GB)',
      'Search is limited (due to encryption)',
      'No third-party app support without Bridge',
    ],
    verdict:
      "Proton Mail proves that you don't have to trade your privacy for a great email experience.",
  },
};
