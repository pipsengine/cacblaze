...
export const techBookReviews: Record<string, TechBookReview> = {
  ...
  'design-patterns': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1508739773434-c26b3d09e071?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyConcepts: [
      'Creational Patterns',
      'Structural Patterns',
      'Behavioral Patterns',
  ...
  ddi: {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1558494949-ef010cbdcc51?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyConcepts: [
  ...
  'cracking-the-coding-interview': {
    ...
    keyConcepts: ['Big O Notation', 'Data Structures', 'Algorithms', 'System Design'],
  ...
  'mythical-man-month': {
    ...
    cons: [
      'Extremely dated tech examples',
      'Some concepts feel obvious now (because of this book)',
    ],
  ...
  'hands-on-ml': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1507146426996-ef05306b995a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyConcepts: [
