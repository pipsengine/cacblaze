...
export const learningAppReviews: Record<string, LearningAppReview> = {
  'duolingo-review': {
    ...
    rating: 4.7,
    description: 'The world\'s most popular language learning platform. Gamified lessons make it addictive and fun to learn a new language daily.',
    author: {
  ...
  'coursera-review': {
    ...
    rating: 4.8,
    description: 'Learn from top universities like Stanford and Yale. Coursera offers professional certificates and even full degrees online.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    specs: {
      ...
      features: ['University Accreditation', 'Guided Projects', 'Specializations', 'Professional Certificates']
    },
  ...
  'khan-academy-review': {
    ...
    rating: 4.9,
    description: 'A non-profit with a mission to provide a free, world-class education for anyone, anywhere. Exceptional for K-12 students.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    specs: {
      ...
      certificateAvailable: false,
      interactiveLessons: true,
      features: ['Personalized Dashboard', 'Practice Exercises', 'Instructional Videos', 'Teacher Tools']
    },
  ...
  'udemy-review': {
    ...
    rating: 4.5,
    description: 'The largest marketplace for online courses. With over 200,000 courses, you can find a tutorial for almost any skill imaginable.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    pros: ['Incredible variety of topics', 'Very affordable during sales', 'Practical, hands-on skills'],
  ...
  'linkedin-learning-review': {
    ...
    rating: 4.4,
    description: 'Combines Lynda.com\'s library with LinkedIn\'s professional network. Certificates are automatically added to your profile.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    pros: ['Seamless career integration', 'High production quality', 'Unlimited access to all courses'],
  ...
  'edx-review': {
    ...
    rating: 4.6,
    description: 'Founded by Harvard and MIT, edX hosts high-level courses from the world\'s best universities. Strong focus on academic rigor.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1513258496099-48168024aec0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
      pricingModel: 'Paid (Audit options available)',
      offlineMode: false,
      certificateAvailable: true,
      interactiveLessons: false,
      features: ['MicroMasters Programs', 'Executive Education', 'University Credit', 'Open Source Platform']
    },
  ...
  'brilliant-review': {
    ...
    rating: 4.8,
    description: 'Learn through problem-solving. Brilliant focuses on building intuition through interactive, visual lessons in math and science.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    specs: {
      ...
      certificateAvailable: false,
      interactiveLessons: true,
      features: ['Interactive Problems', 'Daily Challenges', 'Visual Explanations', 'Community Discussion']
    },
    pros: ['Beautifully designed interactive content', 'Focuses on "why" not just "how"', 'Great for critical thinking'],
  ...
  'masterclass-review': {
    ...
    rating: 4.3,
    description: 'Learn from the best in the world. Classes taught by celebrities like Gordon Ramsay, Natalie Portman, and Neil Gaiman.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    specs: {
      ...
      certificateAvailable: false,
      interactiveLessons: false,
      features: ['Cinematic Production', 'Downloadable Workbooks', 'Audio Mode', 'Community Access']
    },
    pros: ['Unparalleled celebrity instructors', 'Incredible production value', 'Inspiring storytelling'],
  ...
  'sololearn-review': {
    ...
    rating: 4.5,
    description: 'A social platform for learning to code. It breaks down complex programming concepts into bite-sized lessons and quizzes.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  'ulesson-review': {
    ...
    rating: 4.7,
    description: 'Nigeria\'s leading edtech app, tailored for the African curriculum. Provides video lessons and practice tests for primary and secondary school students.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    pros: ['Curriculum-aligned (WAEC/JAMB)', 'High-quality localized animations', 'Offline video downloads'],
