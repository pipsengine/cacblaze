...
export const subscriptionReviews: Record<string, SubscriptionReview> = {
  netflix: {
    ...
    rating: 4.7,
    description:
      'The global leader in streaming entertainment, offering an vast library of original content and licensed favorites.',
    author: {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
  ...
  'spotify-premium': {
    ...
    rating: 4.9,
    description:
      'The definitive music streaming service with industry-leading discovery algorithms and social features.',
    author: {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1614680376593-902f74cf0d41?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    billingCycle: 'Monthly',
    price: '$10.99/mo',
  ...
  'youtube-premium': {
    ...
    rating: 4.8,
    description:
      'An all-in-one package for ad-free video, background play, and YouTube Music access.',
    author: {
      name: 'Sarah "Stream" Johnson',
      role: 'Content Critic',
      image:
    ...
    cons: [
      'Price increases',
      'Limited original content compared to others',
  ...
  'microsoft-365': {
    ...
    rating: 4.6,
    description:
      'The essential office suite integrated with cloud storage and advanced security features.',
    author: {
      name: 'Elena "Pixel" Rossi',
      role: 'Creative Director',
      image:
    ...
    heroImage:
      'https://images.unsplash.com/photo-1633419461186-7d40a38105ec?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    billingCycle: 'Annual',
  ...
  masterclass: {
    ...
    rating: 4.4,
    description:
      'Learn from the worlds best in various fields, from cooking to filmmaking and leadership.',
    author: {
      name: 'Elena "Pixel" Rossi',
      role: 'Creative Director',
      image:
  ...
  'new-york-times': {
    ...
    rating: 4.5,
    description:
      'Quality journalism, investigations, and analysis from one of the worlds most respected news organizations.',
    author: {
      name: 'Marcus "Vinyl" Thorne',
      role: 'Audio Analyst',
      image:
    ...
    cancelationEase: 'Moderate',
    pros: [
      'Excellent deep-dive reporting',
      'Great app experience',
      'Includes Games/Cooking bundles',
    ],
    cons: [
      'Regular price jumps after intro',
      'Paywall can be aggressive',
      'Political bias concerns for some',
    ],
  ...
  'xbox-game-pass': {
    ...
    rating: 4.9,
    description:
      'The "Netflix for Gaming," offering hundreds of high-quality games on console and PC.',
    author: {
      name: 'Marcus "Vinyl" Thorne',
      role: 'Audio Analyst',
      image:
    ...
    heroImage:
      'https://images.unsplash.com/photo-1605901309584-818e25960a8f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    billingCycle: 'Monthly',
    price: '$16.99/mo',
  ...
  'peloton-app': {
    ...
    rating: 4.3,
    description:
      'World-class fitness classes you can take anywhere, with or without Peloton equipment.',
    author: {
      name: 'Sarah "Stream" Johnson',
      role: 'Content Critic',
      image:
    ...
    cons: [
      'Equipment sync is limited for non-Peloton',
      'App-only version lacks some metrics',
      'Can be repetitive',
    ],
  ...
  'duolingo-super': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1543269664-56d93c1b41a6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    billingCycle: 'Annual',
    price: '$83.99/yr',
    freeTrial: '14 Days',
    cancelationEase: 'Very Easy',
    ...
    cons: [
      'Annual billing is steep',
      'Gamification can be stressful',
      'Doesnt replace immersive learning',
    ],
