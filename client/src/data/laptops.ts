...
export const laptopReviews: Record<string, LaptopReview> = {
  'macbook-air-m3': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1517336714460-4c50d917bd7c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
  ...
  'dell-xps-15': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
    ...
    verdict: 'The Dell XPS 15 remains the best 15-inch laptop for creators who prefer Windows. Its OLED screen is breathtaking, and the performance is robust enough for serious video editing and design work. However, the battery life takes a hit due to that gorgeous screen, and the price remains premium.',
    pros: [
