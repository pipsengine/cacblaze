...
export const localVendorReviews: Record<string, LocalVendorReview> = {
  'slot-systems-ikeja': {
    ...
    rating: 4.5,
    description: 'The household name for mobile phones in Nigeria. Their Ikeja flagship store is the go-to for official warranty devices.',
    author: {
    ...
    heroImage: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
  ...
  'hubmart-stores-vi': {
    ...
    rating: 4.7,
    description: 'A premium shopping experience in VI, known for their exceptionally fresh bakery and organized layout.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1534723452862-4c874018d66d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
  ...
  'jid-tech-computer-village': {
    ...
    rating: 4.8,
    description: 'The hidden gem of Computer Village for PC enthusiasts. They specialize in high-end components and professional builds.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
  ...
  'spar-nigeria-lekki': {
    ...
    rating: 4.3,
    description: 'Huge hypermarket offering everything from TVs to towels. Their electronics section often has the best promo deals.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1578916171728-46686eac8d58?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
  ...
  'pointek-online-ikeja': {
    ...
    rating: 4.4,
    description: 'Slot\'s biggest rival. Pointek often has unique bundle deals and a very strong online presence.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1512499617640-c74ae3a79d37?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
  ...
  'h-medix-wuse-abuja': {
    ...
    rating: 4.6,
    description: 'Abuja\'s most trusted name for authentic skincare and pharmaceuticals. The Wuse 2 branch is always stocked.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1586024486164-ce9b3d87e09f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
  ...
  'micro-station-ikeja': {
    ...
    rating: 4.2,
    description: 'Specializes in making tech affordable. Known for their "Phone Swap" programs and budget-friendly focus.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1523206489230-c012c64b2b48?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
      address: 'Otigba Street, Computer Village, Ikeja',
  ...
  'justrite-superstore-isolo': {
    ...
    rating: 4.1,
    description: 'The king of value. Justrite offers competitive pricing for neighborhood shoppers who want to avoid high VI prices.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1583258292688-d0213dc5a3a8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
  ...
  'market-square-ph': {
    ...
    rating: 4.5,
    description: 'A modern hypermarket that has revolutionized shopping in the Garden City. Clean, well-stocked, and professional.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  '3chi-gadgets-abuja': {
    ...
    rating: 4.6,
    description: 'The Apple expert in Abuja. If you need a MacBook or iPhone with official Apple support standards, this is the place.',
    author: {
      name: 'Chidi "Tech" Nwosu',
      role: 'Hardware Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1510557880182-3d4d3cba35a5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
