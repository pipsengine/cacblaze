...
export const hotelReviews: Record<string, HotelReview> = {
  'eko-hotels-suites-lagos': {
    ...
    rating: 4.6,
    description:
      'The most prestigious hotel in Nigeria, known for hosting the biggest events in Lagos and offering unparalleled views of the Atlantic.',
    author: {
    ...
    verdict:
      'The heartbeat of Lagos social life. Ideal for business travelers and those who want to be in the center of the action.',
  },
  'transcorp-hilton-abuja': {
    ...
    rating: 4.8,
    description:
      'The crown jewel of Abuja, Transcorp Hilton is where power players meet. It offers a secure and serene environment in the heart of the capital.',
    author: {
      name: 'Amaka "Jetset" Obi',
      role: 'Travel Editor',
      image:
  ...
  'radisson-blu-ikeja': {
    ...
    rating: 4.4,
    description:
      'A modern and stylish business hotel located in the quiet suburbs of Ikeja GRA, perfect for those needing proximity to the airport.',
    author: {
      name: 'Amaka "Jetset" Obi',
      role: 'Travel Editor',
      image:
  ...
  'the-wheatbaker-lagos': {
    ...
    rating: 4.7,
    description:
      "Lagos' premier boutique hotel, offering a discreet and luxurious sanctuary for the discerning traveler in the quiet streets of Ikoyi.",
    author: {
      name: 'Amaka "Jetset" Obi',
      role: 'Travel Editor',
      image:
    ...
    verdict:
      'A masterpiece of understated luxury. Best for couples or those seeking a quiet retreat.',
  },
  'protea-hotel-port-harcourt': {
    ...
    rating: 4.3,
    description:
      "A reliable and comfortable choice in the Garden City, offering Marriott's global standards with local hospitality.",
    author: {
      name: 'Amaka "Jetset" Obi',
      role: 'Travel Editor',
      image:
