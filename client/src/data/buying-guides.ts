...
export const buyingGuides: Record<string, BuyingGuide> = {
  'best-student-laptops-2026': {
    ...
    description: 'A comprehensive guide to the best budget-friendly and performance-oriented laptops for Nigerian students across all levels.',
    category: 'Laptops',
    author: {
    ...
    recommendations: [
      {
        ...
        description: 'Even in 2026, the M2 Air remains a beast for students. Its battery life is legendary, lasting through multiple lectures even when there is no light in the department.',
      ...
      },
      {
        ...
        description: 'The workhorse of Nigerian campuses. Reliable, easy to repair, and parts are readily available in Computer Village.',
    ...
    buyingTips: [
      {
        ...
        content: 'Since power supply is inconsistent, prioritize laptops with at least 8 hours of real-world battery life.'
      },
      {
        title: 'SSD is Non-Negotiable',
        content: 'Do not buy any laptop in 2026 with a traditional HDD. Ensure it has at least 256GB SSD for speed.'
      }
    ]
  },
  'smartphones-under-200k': {
    ...
    description: 'Looking for a great phone without breaking the bank? Here are the best devices currently available for under 200k.',
    ...
    recommendations: [
      {
        ...
        description: 'Offers a high-refresh-rate AMOLED screen and decent fast charging that helps you top up quickly during brief power flashes.',
      ...
      },
      {
        ...
        description: 'With a massive 7000mAh battery, this is the king of endurance for those who go days without charging.',
    ...
    buyingTips: [
      {
        ...
        content: 'Focus on the physical RAM (e.g., 8GB) rather than the "expanded" RAM (e.g., 8+8GB) for true performance.'
      },
      {
        title: 'Check for 5G Coverage',
        content: 'If you live in Lagos, Abuja, or Port Harcourt, it might be worth spending slightly more for a 5G device.'
      }
    ]
  },
  'best-portable-power-stations': {
    ...
    description: 'Ditch the noisy "I pass my neighbor" generator. Here are the best silent solar-compatible power solutions for Nigerians.',
    category: 'Gadgets',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Tech Editor',
    ...
    lastUpdated: 'Feb 12, 2026',
    heroImage: 'https://images.unsplash.com/photo-1629131726692-1accd0c53ce0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    recommendations: [
      {
        ...
        description: 'Charges from 0-100% in just 70 minutes. Perfect for when the NEPA light only stays for an hour.',
      ...
      },
      {
        ...
        description: 'Compact and powerful enough to run your laptop, monitor, and router for a full workday.',
    ...
    buyingTips: [
      {
        ...
        content: 'These last 10 years compared to the 2-3 years of older Lithium-ion variants. Better for long-term Nigerian use.'
      },
      {
        title: 'Calculate Your Wattage',
        content: 'Always add up the watts of your devices before buying. Don\'t try to run a fridge on a small station!'
      }
    ]
  }
};
