...
export const educationalBooks: Record<string, EducationalBook> = {
  'deep-work': {
    ...
    rating: 4.9,
    description: 'Rules for focused success in a distracted world. This book argues that the ability to focus without distraction is becoming increasingly rare and valuable.',
    reviewer: {
    ...
    whoShouldRead: 'Knowledge workers, students, and anyone looking to improve their focus and productivity in a digital age.',
    pros: ['Actionable strategies', 'Research-backed arguments', 'Timely and relevant'],
    cons: ['Can feel a bit repetitive', 'Some suggestions are hard to implement in traditional offices'],
  ...
  'atomic-habits': {
    ...
    rating: 4.8,
    description: 'An easy and proven way to build good habits and break bad ones. The book focuses on the small changes that lead to remarkable results.',
    reviewer: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1589998059171-988d887df646?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyTakeaways: [
    ...
    whoShouldRead: 'Anyone looking to change their behavior, improve their daily routines, or understand the science of habits.',
    pros: ['Extremely practical', 'Easy to read and apply', 'Great storytelling'],
    cons: ['Some concepts are simplified', 'Heavy focus on individual behavior over systemic issues'],
  ...
  'the-lean-startup': {
    ...
    verdict: 'Essential reading for anyone looking to build a sustainable business in an uncertain environment.'
  },
  'clean-code': {
    id: 'book_4',
    slug: 'clean-code',
    ...
    rating: 4.8,
    description: 'A handbook of agile software craftsmanship. This book is a guide to writing better code.',
    reviewer: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    whoShouldRead: 'Software developers of all levels who want to improve the quality of their code.',
  ...
  'thinking-fast-and-slow': {
    ...
    category: 'Psychology',
    rating: 4.6,
    description: 'A deep dive into the two systems that drive the way we think: System 1 (fast, intuitive) and System 2 (slow, logical).',
    reviewer: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1507413245164-6160d8298b31?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyTakeaways: [
  ...
  'zero-to-one': {
    ...
    rating: 4.5,
    description: 'Notes on startups, or how to build the future. Thiel argues that the best businesses create something entirely new.',
    reviewer: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  'the-psychology-of-money': {
    ...
    category: 'Finance',
    rating: 4.9,
    description: 'Timeless lessons on wealth, greed, and happiness. Housel explores how our emotions and biases affect our financial decisions.',
    reviewer: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyTakeaways: [
    ...
    whoShouldRead: 'Anyone who wants to improve their relationship with money and build long-term wealth.',
  ...
  'show-your-work': {
    ...
    category: 'Creativity',
    rating: 4.7,
    description: '10 ways to share your creativity and get discovered. Kleon argues that being "findable" is as important as being creative.',
    reviewer: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  'sapiens': {
    ...
    category: 'History',
    rating: 4.8,
    description: 'A brief history of humankind. Harari explores how biology and history have defined us and enhanced our understanding of what it means to be "human."',
    reviewer: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1447069387593-a5de0862481e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyTakeaways: [
  ...
  'essentialism': {
    ...
    category: 'Productivity',
    rating: 4.7,
    description: 'The disciplined pursuit of less. Essentialism is about doing only the things that are truly important.',
    reviewer: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
