...
export const gadgetReviews: Record<string, GadgetReview> = {
  'playstation-5-pro': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
    ...
    verdict:
      "The PS5 Pro is a beast of a machine, offering the best possible console gaming experience today. For Nigerian gamers who want 60fps with high-fidelity graphics, it's the ultimate choice, though the price tag is a significant barrier for many.",
    pros: [
  ...
  'starlink-gen-3': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1621416848469-9c51819f31c3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
    ...
    verdict:
      'Starlink Gen 3 has revolutionized internet access in Nigeria. From remote villages to congested Lagos suburbs, it provides consistent high-speed data that local ISPs often fail to deliver. The Gen 3 kit is more robust and easier to set up than the previous version.',
    pros: [
  ...
  'dji-mini-4-pro': {
    ...
    verdict:
      'For Nigerian content creators and wedding videographers, the DJI Mini 4 Pro is a game-changer. It stays under the 250g weight limit (reducing regulatory hurdles) while delivering image quality that rivals much larger drones.',
    pros: [
