...
export const smartphoneReviews: Record<string, SmartphoneReview> = {
  'iphone-15-pro-max': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1695048133142-1a20484d2569?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
  ...
  'samsung-s24-ultra': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
  ...
  'tecno-phantom-v-fold': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1660462998336-64c8d56b4f3b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
  ...
  'infinix-note-40-pro': {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1592899677977-9c10ca588bbd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
