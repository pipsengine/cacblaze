...
export const serviceProviderReviews: Record<string, ServiceProviderReview> = {
  'mtn-fiber-lagos': {
    ...
    rating: 4.4,
    description:
      "MTN's premium fiber service offering dedicated speeds for homes and small offices with reliable uptime.",
    author: {
  ...
  'starlink-nigeria': {
    ...
    rating: 4.6,
    description:
      'Low-earth orbit satellite internet that has changed the game for remote workers and rural areas in Nigeria.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Connectivity Expert',
      image:
    ...
    heroImage:
      'https://images.unsplash.com/photo-1614728894747-a83421e2b9c9?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
      basePrice: '₦38,000/mo',
  ...
  'airtel-5g-router': {
    ...
    rating: 4.2,
    description:
      "Ultra-fast wireless internet using Airtel's expanding 5G network. Great for heavy streamers.",
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Connectivity Expert',
      image:
    ...
    heroImage:
      'https://images.unsplash.com/photo-1562408590-e32931084e23?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
      basePrice: '₦20,000/mo',
  ...
  'tizeti-wifi-lagos': {
    ...
    rating: 3.8,
    description:
      'Known for truly unlimited data plans powered by solar towers. A popular choice for budget-conscious users.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Connectivity Expert',
      image:
  ...
  'coollink-fiber': {
    ...
    rating: 4.1,
    description:
      'A boutique ISP focusing on quality of service and dedicated bandwidth for professionals.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Connectivity Expert',
      image:
  ...
  'spectranet-4g-lte': {
    ...
    rating: 3.7,
    description:
      'The pioneer of 4G in Nigeria. Offers a variety of MiFi and Router options with flexible data plans.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Connectivity Expert',
      image:
  ...
  'ipnx-fiber-lagos': {
    ...
    rating: 4.5,
    description:
      'Consistently ranked as one of the fastest ISPs in Nigeria. Their fiber infrastructure is top-tier.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Connectivity Expert',
      image:
  ...
  'smile-4g-broadband': {
    ...
    rating: 3.9,
    description:
      'Offers high-quality 4G data and VoLTE services. Known for their "SmileVoice" app and reliable MiFis.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Connectivity Expert',
      image:
    ...
    heroImage:
      'https://images.unsplash.com/photo-1520333789090-1afc82db536a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
      basePrice: '₦10,000/mo',
  ...
  'cobranet-fiber': {
    ...
    rating: 4.0,
    description:
      "A long-standing player in the ISP space, offering robust microwave links for areas where fiber can't reach.",
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Connectivity Expert',
      image:
  ...
  'glo-fiber-lagos': {
    ...
    rating: 3.5,
    description:
      "The indigenous giant's foray into fiber. Offers massive data bundles for very competitive prices.",
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Connectivity Expert',
      image:
