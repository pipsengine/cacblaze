...
export const restaurants: Record<string, RestaurantReview> = {
  'the-yellow-chilli-ikeja': {
    ...
    priceLevel: '$$$',
    rating: 4.7,
    description: 'A pioneer in gourmet Nigerian cuisine, The Yellow Chilli offers a sophisticated take on traditional flavors in the heart of Ikeja.',
    author: {
    ...
    verdict: 'Still the gold standard for modern Nigerian dining in Ikeja. Their Seafood Okra is legendary.'
  },
  'ocean-basket-victoria-island': {
    ...
    priceLevel: '$$',
    rating: 4.5,
    description: 'The Mediterranean-style seafood giant remains a favorite for families and casual dates in VI, offering consistent quality and value.',
    author: {
      name: 'Bisi "Foodie" Adebayo',
      role: 'Lifestyle Editor',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  'terra-kulture-food-lounge': {
    ...
    priceLevel: '$$$',
    rating: 4.8,
    description: 'More than just a restaurant, Terra Kulture is a cultural hub where the food is as artistic as the gallery next door.',
    author: {
      name: 'Bisi "Foodie" Adebayo',
      role: 'Lifestyle Editor',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1559339352-11d035aa65de?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    specs: {
    ...
    verdict: 'An essential Lagos experience. The Ofada rice here is unmatched in its presentation and taste.'
  }
};
