...
export const industriesData: Record<string, IndustryData> = {
  'technology': {
    ...
    description: 'The fastest growing sector in Nigeria, driven by Fintech, Edtech, and remote work opportunities.',
    salaryRange: {
    ...
    topRoles: ['Software Engineer', 'Product Manager', 'Data Analyst', 'UI/UX Designer', 'DevOps Engineer'],
    topSkills: ['JavaScript/TypeScript', 'Python', 'React/Next.js', 'Data Analysis (SQL)', 'Cloud (AWS/Azure)'],
  ...
  'finance': {
    ...
    icon: 'BanknotesIcon',
    description: 'A stable and prestigious sector, with traditional banks competing heavily with new-age Fintechs.',
    salaryRange: {
    ...
    topRoles: ['Investment Banker', 'Chartered Accountant', 'Risk Manager', 'Financial Analyst', 'Compliance Officer'],
    topSkills: ['Financial Modeling', 'Risk Assessment', 'Regulatory Compliance', 'Accounting (ICAN/ACCA)', 'Excel'],
  ...
  'oil-gas': {
    ...
    name: 'Oil & Gas',
    icon: 'FireIcon',
    description: 'Historically the highest paying sector in Nigeria, though opportunities are more competitive.',
    salaryRange: {
    ...
    topSkills: ['Project Management', 'Safety Regulations (HSE)', 'Engineering Design', 'Data Interpretation'],
  ...
  'healthcare': {
    ...
    name: 'Healthcare',
    icon: 'HeartIcon',
    description: 'A critical sector facing severe brain drain, leading to high demand for remaining professionals.',
    salaryRange: {
  ...
  'education': {
    ...
    description: 'A sector with wide variance. Private international schools pay well, while public sector lags.',
    salaryRange: {
    ...
    topSkills: ['Curriculum Development', 'Classroom Management', 'EdTech Tools', 'Public Speaking'],
    topEmployers: ['British International School', 'Greensprings', 'Covenant University', 'Lagos Business School'],
