...
export const accessoryReviews: Record<string, AccessoryReview> = {
  'airpods-pro-2': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1588423770d14-b29e96e7438c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
    ...
    verdict: 'The AirPods Pro 2 remain the best earbuds for anyone with an iPhone. The noise cancellation is spooky-quiet, and the transparency mode is still unmatched in the industry. For Nigerians commuting through noisy yellow buses (Danfo) or working in loud generator-powered offices, these are a lifesaver.',
    pros: [
  ...
  'sony-wh-1000xm5': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1644737554464-3fd7d39a89c8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
    ...
    verdict: 'Sony continues to dominate the over-ear market. The XM5 offers a more modern design and even better noise cancellation than its predecessor. It\'s the perfect companion for long flights from Lagos to London or for focusing in a busy open-plan office.',
    pros: [
  ...
  'oraimo-freepods-4': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1590658268037-6bf12165a8df?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    gallery: [
    ...
    verdict: 'The Oraimo FreePods 4 is the king of value in Nigeria. For a fraction of the price of mainstream competitors, you get ANC, transparency mode, and incredible battery life. It\'s the best choice for students and young professionals who want the TWS experience without breaking the bank.',
    pros: [
