...
export const digitalPlatformReviews: Record<string, DigitalPlatformReview> = {
  'amazon': {
    ...
    category: 'E-commerce',
    rating: 4.9,
    description: 'The world\'s largest online retailer and a prominent cloud services provider, redefining global logistics and consumer expectations.',
    author: {
    ...
    heroImage: 'https://images.unsplash.com/photo-1523474253046-2cd2c78a9db1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
  ...
  'stripe': {
    ...
    category: 'Payments',
    rating: 4.9,
    description: 'A developer-first payment processor that has become the financial infrastructure for the internet economy.',
    author: {
      name: 'Bisi "Scale" Adeyemi',
      role: 'Platform Strategist',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    cons: ['Technical knowledge required', 'Can be expensive for high volume', 'Strict fraud prevention can block legit sales'],
  ...
  'shopify': {
    ...
    category: 'E-commerce',
    rating: 4.8,
    description: 'The platform that empowers millions of entrepreneurs to start, grow, and manage their own businesses across all sales channels.',
    author: {
      name: 'Bisi "Scale" Adeyemi',
      role: 'Platform Strategist',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    cons: ['Monthly costs add up', 'Limited design flexibility on basic themes', 'Transaction fees if not using Shopify Payments'],
  ...
  'uber': {
    ...
    rating: 4.6,
    description: 'The pioneer of the gig economy that transformed how the world moves and eats through its ride-sharing and delivery network.',
    author: {
      name: 'Bisi "Scale" Adeyemi',
      role: 'Platform Strategist',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  'google-search': {
    ...
    category: 'Search',
    rating: 4.8,
    description: 'The world\'s primary gateway to information, powered by sophisticated AI and indexing billions of web pages.',
    author: {
      name: 'Bisi "Scale" Adeyemi',
      role: 'Platform Strategist',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    pros: ['Unmatched speed and relevance', 'Rich snippet features', 'Deep integration with Google ecosystem'],
  ...
  'instagram': {
    ...
    rating: 4.5,
    description: 'The visual core of social media that evolved from a photo-sharing app into a cultural and e-commerce powerhouse.',
    author: {
      name: 'Bisi "Scale" Adeyemi',
      role: 'Platform Strategist',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    pros: ['Excellent creative tools', 'Powerful influencer marketing', 'Seamless shopping features'],
  ...
  'paypal': {
    ...
    category: 'Payments',
    rating: 4.4,
    description: 'One of the oldest and most trusted names in online payments, offering consumer protection and merchant services globally.',
    author: {
      name: 'Bisi "Scale" Adeyemi',
      role: 'Platform Strategist',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    heroImage: 'https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    ...
    cons: ['High fees for sellers', 'Funds can be frozen without warning', 'Legacy interface in some areas'],
  ...
  'airbnb': {
    ...
    category: 'Gig Economy',
    rating: 4.7,
    description: 'The platform that democratized travel and hosting, allowing anyone to rent out their space to travelers around the world.',
    author: {
      name: 'Bisi "Scale" Adeyemi',
      role: 'Platform Strategist',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
    ...
    cons: ['Hidden fees (cleaning, service)', 'Impact on local housing markets', 'Inconsistent quality control'],
  ...
  'facebook': {
    ...
    category: 'Social Media',
    rating: 4.2,
    description: 'The social networking giant that defined the modern social era, now part of the broader Meta ecosystem.',
    author: {
      name: 'Bisi "Scale" Adeyemi',
      role: 'Platform Strategist',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  'meta-ads': {
    ...
    rating: 4.8,
    description: 'The most sophisticated targeted advertising platform, allowing businesses to reach users across Facebook, Instagram, and Messenger.',
    author: {
      name: 'Bisi "Scale" Adeyemi',
      role: 'Platform Strategist',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
