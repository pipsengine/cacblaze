...
export const saasReviews: Record<string, SaaSReview> = {
  slack: {
    ...
    rating: 4.8,
    description:
      'The ultimate channel-based messaging platform that connects people, tools, and data in one place.',
    author: {
      name: 'Alex "Tech" Chen',
  ...
  hubspot: {
    ...
    rating: 4.7,
    description:
      'A comprehensive CRM platform that provides all the tools you need for marketing, sales, content management, and customer service.',
    author: {
    ...
    cons: [
      ...
      'Some advanced features require high tiers',
    ],
  ...
  zoom: {
    ...
    rating: 4.6,
    description:
      'The reliable leader in video conferencing, offering seamless meetings, webinars, and chat solutions.',
    author: {
      name: 'Alex "Tech" Chen',
      role: 'Collaboration Expert',
      image:
  ...
  asana: {
    ...
    rating: 4.5,
    description:
      'A flexible work management platform that helps teams stay focused on their goals, projects, and daily tasks.',
    author: {
  ...
  'monday-com': {
    ...
    rating: 4.7,
    description:
      'A highly visual Work OS that allows teams to build custom workflows and manage everything from projects to sales.',
    author: {
      name: 'James "Process" Wilson',
      role: 'Operations Consultant',
      image:
    ...
    cons: [
      'Pricing per seat groups',
      'Mobile app lacks some features',
      'Complex automations can be tricky',
    ],
  ...
  shopify: {
    ...
    rating: 4.9,
    description:
      'The leading e-commerce platform that allows anyone to set up an online store and sell their products.',
    author: {
      name: 'Elena "Growth" Rodriguez',
      role: 'SaaS Strategist',
      image:
    ...
    cons: [
      ...
      'Customization requires Liquid knowledge',
  ...
  okta: {
    ...
    rating: 4.8,
    description:
      'An independent provider of identity for the enterprise, offering secure identity management and single sign-on.',
    author: {
      name: 'Mike "Dev" Miller',
      role: 'Systems Architect',
      image:
  ...
  'quickbooks-online': {
    ...
    rating: 4.4,
    description:
      'The standard cloud-based accounting software for small businesses and freelancers.',
    author: {
      name: 'Elena "Growth" Rodriguez',
      role: 'SaaS Strategist',
      image:
  ...
  trello: {
    ...
    rating: 4.3,
    description:
      'A visual tool that empowers teams to manage any type of project, workflow, or task tracking.',
    author: {
      name: 'James "Process" Wilson',
      role: 'Operations Consultant',
      image:
    ...
    heroImage:
      'https://images.unsplash.com/photo-1540350394557-8d14678e7f91?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    pricingModel: 'Freemium',
    ...
    cons: [
      'Lacks depth for complex projects',
      'Limited reporting',
      'Butler automation limits on lower tiers',
    ],
