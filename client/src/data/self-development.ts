...
export const selfDevelopmentReviews: Record<string, SelfDevelopmentReview> = {
  'masterclass-productivity': {
    ...
    rating: 4.8,
    description: 'A comprehensive deep dive into habit formation and productivity systems by the author of Atomic Habits.',
    author: {
  ...
  'headspace-meditation': {
    ...
    rating: 4.7,
    description: 'The world\'s most popular meditation app designed to make mindfulness accessible to everyone.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  'getting-things-done': {
    ...
    rating: 4.9,
    description: 'David Allen\'s legendary time management method that promises stress-free productivity.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  'the-morning-miracle': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    keyFeatures: [
      'Silence (Meditation)',
      'Affirmations',
      'Visualization',
  ...
  'coursera-specialization': {
    ...
    rating: 4.9,
    description: 'The world\'s most popular MOOC that teaches you the neuroscience of effective learning.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
  ...
  'notion-second-brain': {
    ...
    rating: 4.8,
    description: 'A methodology for capturing and organizing ideas using digital tools like Notion.',
    author: {
      name: 'Tunde "Gadget" Bakare',
      role: 'Fintech Analyst',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80'
