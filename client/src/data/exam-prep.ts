...
export const examPrepResources: Record<string, ExamPrepResource> = {
    ...
    tips: [
      {
        ...
        content: 'JAMB provides a specific syllabus for each subject. Stick to it strictly.',
      },
      {
        title: 'Practice Past Questions',
        content: 'Use the official JAMB CBT software to familiarize yourself with the interface.',
      },
      { title: 'Time Management', content: 'Practice answering 180 questions in 120 minutes.' },
      {
        title: 'Novel Study',
        content: "Don't forget to read the mandatory English novel recommended for the year.",
      },
    ],
    author: {
  ...
  'waec-ssce-prep': {
    ...
    rating: 4.7,
    description:
      'The West African Senior School Certificate Examination (WASSCE) is a type of standardized test in West Africa, taken by students who have completed secondary education.',
    heroImage:
    ...
    tips: [
      {
        ...
        content: 'WAEC tests your understanding of core concepts from SS1 to SS3.',
      },
      {
        title: 'Handwriting & Presentation',
        content: 'For theory papers, clear handwriting and structured answers earn more marks.',
      },
      {
        title: 'Practical Sessions',
        content: 'Ensure you participate fully in school lab sessions for sciences.',
      },
      {
        title: 'Chief Examiner Reports',
        content: 'Read previous reports to understand common mistakes made by students.',
      },
    ],
    author: {
    ...
    tips: [
      {
        ...
        content: 'Each section has specific question types. Learn the strategies for each.',
      },
      {
        title: 'Vocabulary Building',
        content:
          'Focus on academic collocations and synonyms to improve your writing and speaking.',
      },
      {
        title: 'Mock Tests',
        content: 'Take timed mock tests to build stamina for the 2 hour 45 minute exam.',
      },
      {
        title: 'Speaking Practice',
        content: 'Record yourself speaking and listen for fluency, pronunciation, and grammar.',
      },
    ],
    author: {
      name: 'Sarah Thompson',
  ...
  'gre-comprehensive-guide': {
    ...
    rating: 4.6,
    description:
      'The Graduate Record Examinations (GRE) is a standardized test that is an admission requirement for many graduate schools in the United States and Canada.',
    heroImage:
    ...
    tips: [
      {
        ...
        content: 'Brush up on high school math concepts like algebra, geometry, and data analysis.',
      },
      {
        title: 'Reading Comprehension',
        content: 'Read high-level publications like The Economist or Scientific American.',
      },
      {
        title: 'Essay Templates',
        content:
          'Develop a structure for both the "Analyze an Issue" and "Analyze an Argument" tasks.',
      },
      {
        title: 'Error Log',
        content: 'Keep track of questions you get wrong and why you missed them.',
      },
    ],
    author: {
  ...
  'neco-senior-school-prep': {
    ...
    rating: 4.5,
    description:
      'The National Examinations Council (NECO) is an examination body in Nigeria that conducts the Senior Secondary Certificate Examination (SSCE) in June/July.',
    heroImage:
    ...
    tips: [
      {
        ...
        content: 'Ensure you are using the latest NECO syllabus for your subject areas.',
      },
      {
        title: 'Practical Readiness',
        content:
          'NECO practicals can be quite detailed; ensure you know your apparatus and procedures.',
      },
      {
        title: 'Time Allocation',
        content: 'Balance your time between objective and theory questions effectively.',
      },
      {
        title: 'Clear Expression',
        content: 'Focus on clear, concise definitions and explanations in theory papers.',
      },
    ],
    author: {
