...
export const cafeReviews: Record<string, CafeReview> = {
  'art-cafe-victoria-island': {
    ...
    rating: 4.8,
    description:
      'A cozy and eclectic cafe that doubles as an art gallery. Known for its quiet atmosphere, perfect for working or intimate conversations.',
    author: {
    ...
    verdict:
      'The best spot in VI for a quiet coffee and focused work. Their flat white is exceptional.',
  },
  'vibe-by-the-waterfront-lekki': {
    ...
    rating: 4.5,
    description:
      'A vibrant and trendy spot overlooking the Lekki-Ikoyi link bridge. Ideal for weekend brunch and socializing.',
    author: {
      name: 'Tobi "Caffeine" Bakare',
      role: 'Coffee Enthusiast',
      image:
  ...
  'mai-shayi-coffee-abuja': {
    ...
    rating: 4.6,
    description:
      'A modern tribute to the traditional "Mai Shayi" culture, offering premium Northern coffee blends in a contemporary setting.',
    author: {
      name: 'Tobi "Caffeine" Bakare',
      role: 'Coffee Enthusiast',
      image:
    ...
    verdict:
      'A must-visit for coffee lovers in Abuja. Their signature spiced coffee is a game changer.',
  },
};
